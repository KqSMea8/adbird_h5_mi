...
!function() {
    ...
    function n() {
        ga("send", "event", "Solitaire", "Loaded", "Load Time", 1 * new Date),
        isCordova ? setTimeout(app.onAllLoaded, 1) : isWrapped || r(vpath + "content.js");
        var t = document.getElementsByTagName("content")[0];
        t.parentNode.removeChild(t),
        t = null
    }
    function s(t) {
        isClay ? (window.open(t, "_blank"),
        navigator.app && navigator.app.loadUrl && navigator.app.loadUrl(t, {
            openExternal: !0
        })) : isCordova ? isAndroid ? navigator.app.loadUrl(t, {
            openExternal: !0
        }) : window.open(t, "_system", "location=yes") : window.open(t, "_blank"),
        toggleMenu(!1)
    }
    function a(t, e) {}
    function o() {
        ...
        function r(t) {
            ...
            if (e)
                for (var r = 0; r < e.length; r++)
                    i(e[r].replace(/[^A-Za-z]embed\([\"|\'](.+)[\"|\']\)/g, "$1"))
        }
        var n = 0
          , s = 0;
        s = 0,
        n++;
        for (var o = arguments, h = 0; h < o.length; h++)
            r(o[h]);
        e()
    }
    function h() {
        ...
        function u(t, e, i) {
            ...
            t.mousedown = t.mousedown || function() {}
            ,
            t.touchstart = t.touchstart || function() {}
            ,
        ...
        function f(t, e) {
            function i(t) {
                this.suit = t / 13 | 0,
                this.color = this.suit < 2 ? 0 : 1,
                this.value = t % 13,
                this.id = t,
                this.parent = null,
                this.flipped = !0,
                this.quickFlip = this.flip = function(t) {
                    this.flipped = t
                }
            }
            function r() {
                this.cards = [],
                this.addCards = function(t) {
                    for (var e = 0; e < t.length; e++) {
                        var i = t[e];
                        i.parent && i.parent.removeCard(i),
                        i.parent = this,
                        this.cards.push(i)
                    }
                }
                ...
                this.removeCard = function(t) {
                    for (var e = 0; e < this.cards.length; e++)
                        if (t == this.cards[e])
                            return void this.cards.splice(e, 1)
                }
                ,
                this.add = function(t) {
                    this.addCards([t])
                ...
                for (var t = 7 * u() >> 0, e = 4 * u() >> 0, i = 0; 4 > i; i++) {
                    ...
                    if (n)
                        for (var s = 0; 7 > s; s++) {
                            ...
                            if (h) {
                                if (h.flipped && o.cards.length < a + 1)
                                    return o.addCards([n]),
                                    !0;
                                if (h.color != n.color && h.value == n.value + 1)
                                    return o.addCards([n]),
                                    !0
                            } else if (a > 3)
                                return o.addCards([n]),
                ...
                for (var t = 0; t < y.length; t++) {
                    ...
                    if (1 == e.cards.length && 0 != t && (12 != i.value || u() > .9)) {
                        if (!i.flipped)
                            return i.flip(!0),
                            !0
                    } else if (e.cards.length > 1 && e.cards.length < t + 1 && !i.flipped && e.cards[e.cards.length - 2].flipped)
                        return i.flip(!0),
                        !0
                }
            }
                ...
                if (t.length > 0) {
                    ...
                    if (r.length > 0)
                        for (var s = u() * r.length >> 0, a = r[s], o = u() * t.length >> 0, e = 0; e < t.length; e++) {
                            ...
                            if (u(),
                            f = (d * u() >> 0) + h,
                            a.cards[f].value <= 1 && u() > .7 && (f = (d * u() >> 0) + h),
                            f != h || 12 == a.cards[f].value && 0 == f) {
                                for (var p = [], e = f; e < a.cards.length; e++)
                                    p.push(a.cards[e]);
                                return l.addCards(p),
                                !0
                            }
                ...
                if (t > 28) {
                    if (u() > .7 || 38 > t) {
                        for (var i = y[0], r = 0, e = 0; 7 > e; e++) {
                            for (var n = y[e], s = 0, a = 0; a < n.cards.length; a++)
                                n.cards[a].flipped || s++;
                            s >= r && (i = n,
                            r = s)
                        }
                        for (var e = 0; 7 > e; e++) {
                            ...
                            if (h && l && !h.flipped && !l.flipped)
                                return m.addCards([h]),
                                !0;
                            if (h && 12 == h.value && 1 == n.cards.length && 0 != o)
                                return m.addCards([h]),
                                !0
                        }
                    }
            ...
            function h() {
                if (m.cards.length >= 3 && u() > .5)
                    for (var t = 0; 3 > t; t++)
                        v.add(m.cards[m.cards.length - 1]);
                else if (0 != v.cards.length && u() > .5)
                    for (; v.cards.length; )
                        m.add(v.cards[v.cards.length - 1])
            }
            function l() {
                for (var t = !0, e = 0; e < y.length; e++)
                    y[e].cards.length != e + 1 && (t = !1);
                for (var e = 0; e < x.length; e++)
                    0 != x[e].cards.length && (t = !1);
                if (t) {
                    if (!S) {
                        for (var i = 0, e = 0; e < y.length; e++)
                            for (var r = y[e], l = 0; l < r.cards.length; l++)
                                r.cards[l].flipped || i++;
                        for (; m.cards.length; )
                            v.add(m.cards[m.cards.length - 1]);
                        return 7 == i && (M = !0),
            ...
            function c(t, e, i) {
                for (var r = 0; r < e.cards.length; r++) {
                    var n = e.cards[r]
                      , s = tt[n.id];
                    n.flipped != s.flipped && (t ? s.flip(n.flipped) : s.quickFlip(n.flipped)),
                    t ? i.addCards([s]) : i.add(s)
                }
            }
            function d(t) {
                for (var e = 0; e < x.length; e++)
            ...
            for (var p = 0; p < tt.length; p++) {
                var g = tt[p];
                gt.addChild(g),
                g.container && (g.container.remove(g),
                g.y = g.x = -500,
                g.rotation = g.targetRotation = 0,
                g.quickFlip(!1)),
                g.clear(!0)
            }
            for (var v = new r, m = new r, y = [], x = [], w = [], p = 0; 7 > p; p++)
                y.push(new r);
            for (var p = 0; 4 > p; p++)
                x.push(new r);
            for (var p = 0; 52 > p; p++)
                w.push(new i(p));
            for (var b = w.concat([]), p = 0; 13 > p; p++)
                x[0].add(b[p]),
                x[1].add(b[p + 13]),
                x[2].add(b[p + 13 + 13]),
                x[3].add(b[p + 13 + 13 + 13]);
            for (var p = 0; 52 > p; p++)
                b[p].quickFlip(!1);
            isFirstRun = !0;
        ...
        function g() {
            if (Z.length) {
                ...
                for (var t = Z.pop(), e = et[t[1]], i = [], r = 2; r < t.length; r++)
                    i.push(tt[t[r]]);
                e.addCards(i, !0, t[0])
            }
        }
        function v() {
            ga("send", "event", "Solitaire", "Won Game (" + (currentGameData.draw3 ? 3 : 1) + ")", "Time Spend", (new Date).getTime() - nt),
            onGameWin(),
            Store.remove(storeVersion),
            it = !0,
            b()
        }
        function b() {
            ...
            var t = 0
              , e = setInterval(function() {
                ...
                setTimeout(function() {
                    function t() {
                        r.removeChild(n),
                        n = tt[tt.length - 1 - (u % 4 * 13 + u / 4 | 0)],
                        o = n.ratio;
                        var t = Math.min(Math.abs(S / M - 1.66) + .4, 1);
                        s = (10 + S / M * 3 + S / M * 3 * Math.random()) * (Math.random() * t > .5 ? -1 : 1),
                        a = -40 * Math.random() * Math.random(),
                        c = .007 * s,
                        s *= o,
                        r.addChild(n),
                        n.x = gt.x + n.x * o,
        ...
        function L() {
            ...
            var e = Math.min(jt + gt.x / t - (213 + zt), 9 * (213 + zt) + zt)
              , i = 8 * (213 + zt) + 3 * zt
              , r = (i - e) / 2;
            R ? Ut.moveTo(e + r, a / 2 - (282 + zt) / 2 + .8 * (282 + zt)) : Ut.moveTo(6 * (213 + zt) + zt, zt + s),
            R ? It.moveTo(e + r, a / 2 - (282 + zt) / 2 - .8 * (282 + zt)) : It.moveTo(4 * (213 + zt) + 2 * zt, zt + s)
        }
        function D() {
            P.width = E * C + 5,
            P.height = M * C + 5,
            G.fillStyle = "rgb(0, 50, 10)",
            G.fillRect(0, 0, P.width, P.height);
            var t = G.createRadialGradient(E * C / 2, 0, 0, E * C / 2, 0, 1.2 * Math.max(.65 * E, M) * C);
            t.addColorStop(0, "rgb(0, 100, 20)"),
            t.addColorStop(1, "rgb(0, 25, 10)"),
            G.fillStyle = t,
            G.fillRect(0, 0, P.width, P.height);
            var e = G.createPattern(Kt, "repeat");
            G.fillStyle = e,
            G.fillRect(0, 0, P.width, P.height),
            qt.texture.destroy(!0);
            var i = Math.min(Math.min(S / Qt.width / 3, M / Qt.height / 3), 1)
              , r = Qt.width * i * C
              , n = Qt.height * i * C;
            G.drawImage(Qt, E * C / 2 - r / 2, M * C - n - 60 * C, r, n),
            qt.setTexture(new d.Texture.fromCanvas(P))
        }
        function F(t, i, r, n) {
            ...
            for (var s = 0; s < tt.length; s++) {
                var a = tt[s];
                gt.addChild(a),
                a.defaultCursor = "default",
                a.container && (a.container.remove(a),
                a.y = a.x = -500,
                a.rotation = a.targetRotation = 0,
                a.quickFlip(!0))
            }
            var o = !1;
            if (t && Store.get(storeVersion))
                try {
                    var h = 0
                    ...
                    for (var s = 0; s < c.length; s++)
                        "0" == c[s] && (tt[s].quickFlip(!1),
                        tt[s].defaultCursor = "pointer");
                    for (var s = h; s < l.length; s++)
                        if ("" != l[s])
                            for (var d = l[s].split("."), u = et[s - h], g = 0; g < d.length; g++)
                                u.addCards([tt[parseInt(d[g])]], !0);
                    o = !0
                } catch (v) {
                    console.log(v)
                }
            t && (o ? ga("send", "event", "Solitaire", "Resume Game " + (" (" + (i ? 3 : 1) + ")"), "Games Played", at) : (date = new Date,
            random = !0,
            i = !1,
            ga("send", "event", "Solitaire", "New Game " + (" (First " + (i ? 3 : 1) + ")"), "Games Played", at))),
            at++,
            o || f(n),
            currentGameData = {
                seed: n,
        ...
        function U() {
            for (var t = [], e = 0; e < Z.length; e++) {
                for (var i = Z[e], r = [i[0] ? 1 : 0], n = 1; n < i.length; n++)
                    r.push(i[n]);
                t.push(r.join("."))
            }
            return t.join("x")
        ...
        function W(t) {
            ...
            for (var e = t.split("x"), i = 0; i < e.length; i++)
                if (e[i].length) {
                    for (var r = e[i].split("."), n = ["1" == r[0]], s = 1; s < r.length; s++)
                        n.push(parseInt(r[s]));
                    Z.push(n)
                }
        }
        function N() {
            for (var t = "", e = 0; e < tt.length; e++)
                t += tt[e].flipped ? "1" : "0";
            for (var i = [U(), t, currentGameData.seed, currentGameData.offset, currentGameData.draw3 ? 1 : 0], e = 0; e < et.length; e++)
                i.push(et[e].serialize());
            return i.join("|")
        }
        function k() {
            clearTimeout(Zt),
        ...
        function j() {
            ...
            r = 3),
            ge.redraw(),
            calenderView.ratio = Math.min(Math.min(M * C / 800, S * C / 1e3), C / 2),
            calenderView.reAlign();
        ...
        function V(t, e) {
            window.toggleMenu(!1),
            ge.show(new le(t,e)),
            window.showNewGameDialogue()
        }
        function Y(t, e, i) {
            isCordova && window.app && app.onStartNewGame && app.onStartNewGame();
            var r = ot ? "Restart Game" : "New Game";
            ga("send", "event", "Solitaire", r + (" (" + (t ? 3 : 1) + ")"), "Games Played", at),
            ot = !1,
            st = !1,
            ge.hide(function() {
                B.removeChild(calenderView),
                B.addChild(gt),
                B.addChild(Et),
                B.addChild(Rt),
                F(!1, t, e, i)
        ...
        function z() {
            ...
            currentGameData.usedUndo || t++,
            calenderView.setStars(currentGameData.offset, t),
            ge.show(new ne(currentGameData.offset,t,window.youWinDialogueCallback,window.shareDialogueCallback))
        }
        function X() {
            ge.show(new ae)
        }
        ...
        var gt = new m
          ...
          , mt = function(t) {
            ...
            a.x = +r.width / 2 - 30 - a.width,
            a.y = -r.height / 2 + 30,
            a.frame = this.suit,
            i.addChild(a);
            var o = new T(embed("i/g/symbolssmall.png"),19,23);
            o.x = -r.width / 2 + 33,
            o.y = -r.height / 2 + 30 + 50,
            o.frame = this.suit,
            i.addChild(o);
            var h = new T(embed("i/g/numbers.png"),58,40);
            if (h.x = -r.width / 2 + 15 + (11 == this.value ? 10 : 0),
            h.y = -r.height / 2 + 30,
            h.frame = this.value + 13 * this.color,
            i.addChild(h),
            this.value >= 10) {
                var l = new T(embed("i/g/facecards.png"),172,235);
                l.frame = this.value - 10 + 3 * this.suit,
                i.addChild(l),
                l.x = -l.width / 2,
                l.y = -l.height / 2 + 10
            } else {
            ...
            this.flip = function(t, e, i) {
                p.clear(this.scale),
                f == t ? (1 !== u.scale.x || 1 !== u.scale.y) && new p(u.scale,{
                    y: 1,
                    x: 1
            ...
            this.quickFlip = function(t, r) {
                (this.flipped != t || r) && (f = this.flipped = t,
                t ? (u.addChild(e),
                u.removeChild(i)) : (u.removeChild(e),
                u.addChild(i)))
            }
            ,
            this.clear = function(t) {
                p.clear(this),
                t === !0 && p.clear(this.scale)
            }
            ,
        ...
        mt.prototype = Object.create(m.prototype),
        ...
        var yt = function(t) {
            function e(t, e) {
                ...
                t.touchstart = a.touchstart,
                t.touchmove = a.touchmove,
                t.touchend = function(e) {
                    Q = !0,
                    delete t.mouseup,
                    t.touchend = i,
            ...
            function i(i, r, n, a) {
                ...
                i.x = r,
                i.y = n,
                void 0 !== a && (i.interactive = !0,
                i.buttonMode = !0,
                i.defaultCursor = "pointer",
                e(i, function() {
                    s(a)
                })),
                i
            ...
            this.addSocialBar = function() {
                var e = new m;
                e.addChild(i(w.fromSheet(iconSheet, 5), 20, 15, "http://news.frvr.com")),
                e.addChild(i(w.fromSheet(iconSheet, 7), 150, 15, "http://twitter.com/frvrgames")),
                e.addChild(i(w.fromSheet(iconSheet, 0), 280, 15, "http://www.facebook.com/frvrgames")),
                e.addChild(i(w.fromSheet(iconSheet, 2), 410, 15, "http://plus.google.com/+Frvrgames")),
                e.y = f,
                o.addChild(e),
                f += 41 * t
            }
            ...
            this.addMenuHeader = function(e) {
                var i = new m
                  , n = new d.Graphics;
                n.beginFill(2236962),
                n.drawRect(0, -2, 250 * t, 34 * t),
                i.addChild(n),
                i.addChild(r(e, {
                    font: "200 35px sans-serif",
                    fill: "#ffffff"
                }, 11 * t, 6 * t)),
                i.y = f,
                o.addChild(i),
            ...
            this.addMenuToggle = function(n, s, a, h) {
                ...
                u.moveTo(0, 40 * t),
                u.lineTo(250 * t, 40 * t),
                u.lineStyle(1, 16777215, .2),
                u.moveTo(0, 41 * t),
                u.lineTo(250 * t, 41 * t),
                c.addChild(i(n, 15, 15)),
                c.addChild(r(s, {
                    font: "200 35px sans-serif",
                    fill: "#ffffff"
                }, 40 * t, 11 * t)),
            ...
            this.addMenuItem = function(n, s, a) {
                ...
                l.moveTo(0, 40 * t),
                l.lineTo(250 * t, 40 * t),
                l.lineStyle(1, 16777215, .2),
                l.moveTo(0, 41 * t),
                l.lineTo(250 * t, 41 * t),
                h.addChild(i(n, 15, 15)),
                h.addChild(r(s, {
                    font: "200 35px sans-serif",
                    fill: "#ffffff"
                }, 40 * t, 11 * t)),
                h.interactive = !0,
                h.buttonMode = !0,
                h.defaultCursor = "pointer",
                h.y = f,
                h.hitArea = new d.Rectangle(0,0,250 * t,35 * t),
                e(h, a),
                o.addChild(h),
                f += 42 * t,
                h
        ...
        yt.prototype = Object.create(m.prototype),
        ...
        var xt = function(t) {
            ...
            this.addCards = function(t, e) {
                if (e !== !0) {
                    ...
                    for (var s = [i, t[0].container.historyId], a = [], n = 0; n < t.length; n++)
                        a.push(t[n].id);
                    a.reverse(),
                    Z.push(s.concat(a))
                }
            ...
            this.add = function(t, e) {
                t.container && t.container.remove(t),
                t.container = this,
                e !== !0 && t.parent.addChild(t),
                this.cards.push(t)
            }
            ,
          ...
          , wt = function(t) {
            ...
            var i = this.add
              ...
              , n = 0;
            this.add = function(t, e) {
                t.defaultCursor = "pointer",
                t.targetRotation = (Math.random() - .5) / 3,
                i.call(this, t, e)
            }
            ;
            var s = this.addCards;
          ...
          , bt = function(t) {
            function e(t) {
                ...
                o = setTimeout(function() {
                    for (var e = 0; e < a.cards.length; e++) {
                        var i = a.cards[e];
                        i.defaultCursor = e == a.cards.length - 1 ? "pointer" : "default",
                        i.clear(!0);
            ...
            var o = 0;
            this.requestDrag = function(t) {
                return t === this.cards[this.cards.length - 1] ? (t.clear(),
                t.parent.addChild(t),
                t) : void 0
            }
            ,
            this.setTargets = function(t, e) {
                for (var i = 0; i < this.cards.length; i++) {
                    ...
                    R ? (r.targetX = t + 106.5 + 1,
                    n > i ? r.targetY = e + 141 + 1 : r.targetY = e + 80 * (i - n) + 141 + 1) : (n > i ? r.targetX = t + 106.5 + 1 : r.targetX = t + 80 * (i - n) + 106.5 + 1,
                    r.targetY = e + 141 + 1)
                }
            }
            ,
          ...
          , Tt = function(t) {
            ...
            this.requestDrop = function(t) {
                if (0 == this.cards.length) {
                    ...
                    if (e.suit == t.suit && t.value == e.value + 1)
                        return !0
                }
                return !1
            }
          ...
          , St = function(t) {
            function e(t) {
                ...
                l = setTimeout(function() {
                    ...
                    for (var s = o.cards.length - e, a = Math.min(.05, .4 / s), h = e; h < o.cards.length; h++) {
                        var i = o.cards[h];
                        i.defaultCursor = i.flipped ? "default" : "pointer",
                        p.clear(i),
                        i.targetRotation = 0,
                        !function(i, r) {
                            var n = t ? s - r : r - e;
            ...
            var r = 0
              ...
              , o = this;
            this.requestDrag = function(t) {
                if (t === this.cards[this.cards.length - 1])
                    return t.clear(),
                    t.parent.addChild(t),
                    t;
                if (t.flipped === !1)
            ...
            ,
            this.requestDrop = function(t) {
                if (t instanceof Ct && (t = t.cards[0]),
                0 == this.cards.length) {
                    if (12 == t.value)
                        return !0
                } else {
                    var e = this.cards[this.cards.length - 1];
                    if (t.value == e.value - 1 && t.color != e.color)
                        return !0
                }
                return !1
            }
            ...
            this.setTargets = function(t, e) {
                if (0 != this.cards.length) {
                    for (var i = 0, r = 0; r < this.cards.length && this.cards[r].flipped; r++)
                        i++;
        ...
        window.menu = new yt(C),
        window.toggleMenu = function(i) {
            return menu.active !== i ? (i === !0 && (menu.show(),
            t()),
            p.clear(B),
            new p(B,{
                x: i ? 250 * C : 0
        ...
        for (var It = new bt(4), Ut = new wt(5), Wt = [], Ft = 0; 7 > Ft; Ft++)
            Wt.push(new St(6 + Ft));
        Ut.requestDrag = function(t) {
            if (0 == this.cards.length) {
                ...
                for (var i = [], r = Math.min(currentGameData.draw3 ? 3 : 1, this.cards.length), n = 0; r > n; n++)
                    i.push(this.cards[this.cards.length - n - 1]);
                It.addCards(i)
            }
        }
        ,
        ...
        for (var Ft = 0; 52 > Ft; Ft++) {
            var Nt = new mt(Ft);
            c(Nt, function(t) {
                if (!toggleMenu(!1) && !_t && (Gt = (new Date).getTime(),
                _t = this.container.requestDrag(this),
                void 0 !== _t)) {
                    var e = t.getLocalPosition(A);
                    At = e.x / this.ratio - _t.x,
                    Lt = e.y / this.ratio - _t.y,
                    Bt = _t.x,
                    Pt = _t.y
                }
            }),
        ...
        B.touchmove = function(t) {
            if (!it && void 0 !== _t) {
                var e = t.getLocalPosition(A);
                _t.x = e.x / _t.ratio - At,
                _t.y = e.y / _t.ratio - Lt
            }
        }
        ,
        ...
        B.touchend = B.mouseup = function(t) {
            ...
            if (!it) {
                if (_t) {
                    ...
                    e(-o + n, -h),
                    e(-o + n, -h + s),
                    ut.clickToMove && !i && (new Date).getTime() - Gt < 500)
                    ...
                    if (i === !0)
                        for (var l = 0; l < Wt.length; l++)
                            Wt[l].flip();
                    else if (_t instanceof Ct)
                        _t.cards[0].container.addCards(_t.cards, !0);
                    else {
                        var d = _t.container;
                        d.addCards([_t], !0)
                    }
                    for (var u = 0 == Ut.cards.length && 0 == It.cards.length, l = 0; l < Wt.length; l++)
                        Wt[l].isComplete() || (u = !1);
                    u && J && v()
                }
                _t = void 0
        ...
        ,
        window.winGame = v;
        var jt, Vt, Yt, Ht = new d.Sprite(d.Texture.emptyTexture), zt = 20, Xt = window.onresize, qt = new d.Sprite(new d.Texture.fromCanvas(document.createElement("canvas"))), Kt = embed("i/g/texture.png");
        qt.interactive = !0;
        var Qt = embed("i/g/backgroundlogo.png");
        qt._renderWebGL = function(t) {
            this._dirtyTexture && (this._dirtyTexture = !1,
            d.updateWebGLTexture(this.texture.baseTexture, t.gl)),
            d.Sprite.prototype._renderWebGL.call(this, t)
        }
        ,
        D();
        var Jt = ([")f+'=xh?/|//'=noitacol.d(:l"][0] + ["lun?)f(tset./)|(/;niamod.d=f rav"][0]).split("").reverse();
        menu.addMenuHeader("Solitaire GameBox"),
        menu.addMenuItem(w.fromSheet(iconSheet, 3), "New Game", function() {
            O(),
            V(currentGameData.offset)
        }),
        menu.addMenuItem(w.fromSheet(iconSheet, 4), "Restart game", function() {
            O(),
            ot = !0,
            V(currentGameData.offset, currentGameData.seed)
        }),
        ...
        menu.addMenuHeader("Settings"),
        menu.addMenuToggle(w.fromSheet(iconSheet, 13), "Click to move", ut.clickToMove, I),
        //menu.addMenuHeader("More Information"),
        /*menu.addMenuItem(w.fromSheet(iconSheet, 1), "FRVR Website", function() {
            s("http://frvr.com")
        }),
        menu.addMenuItem(w.fromSheet(iconSheet, 6), "Send Feedback", function() {
            s("http://frvr.uservoice.com/forums/263624-solitaire-frvr/")
        }),
        menu.addMenuItem(w.fromSheet(iconSheet, 9), "Legal", function() {
        ...
        var Zt, $t = 1e3 / 60, te = (new Date).getTime();
        l = function() {
            var t = (new Date).getTime();
            for (t - te > 5e3 && (te = t); t > te; te += $t)
                p.tick(),
                menu.tick()
        }
        ;
        ...
        ee.prototype = Object.create(d.Text.prototype),
        ee.prototype.constructor = ee;
        var ie = function() {
            m.call(this),
            this.innerHeight = 800,
            this.blurClose = !0,
            this.createHeadline = function(t) {
                var e = new ee(t,200,90,"#2c2c2c",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            ...
            this.createButton = function(t, e, i) {
                ...
                t && (r.addChild(t),
                t.y = 50);
                var n = new ee(e,200,45,"#ffffff",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
                n.updateText(),
                n.y = 50,
                r.addChild(n);
                var s = (400 - (64 + n.width)) / 2;
                return t ? i ? (t.x = s,
                n.x = s + 64) : (t.x = s + n.width + 5,
                n.x = s) : n.x = (400 - n.width) / 2,
                r
            }
        };
        ...
        var re = ["Outstanding", "Exceptional", "Amazing", "Astonishing", "Astounding", "Marvelous", "Wonderful", "Extraordinary", "Stunning", "Impressive", "Incredible"]
          , ne = function(t, e, i, r) {
            ie.call(this),
            this.createHeadline(re[Math.random() * re.length >> 0] + "!");
            var n = new m;
            n.x = 400,
            n.y = 295,
            n.isLocked = function() {
            ...
            this.addChild(a),
            a.beginFill(8042350, 1),
            a.drawRoundedRect(0, 0, 800, 180, 35);
            var o = new d.Graphics;
            this.addChild(o),
            o.beginFill(15658734, 1),
            o.drawRect(0, 0, 800, 180);
            var h = ["Perfectly played!", "Well done!"][2 * Math.random() >> 0];
            3 != e && (h = "Win draw 3 without undo for 3 stars!");
            var l = new ee(h,100,40,"#2c2c2c",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            if (l.anchor.set(.5, 1),
            l.x = 400,
            l.y = 480,
            this.addChild(l),
            i) {
                ...
                this.addChild(c),
                c.beginFill(4675430, 1),
                c.drawRect(0, 0, 800, 150);
                var f = this.createButton(w.fromSheet(iconSheet, 0), "Facebook Connect", !0);
                this.addChild(f),
                f.x = 200,
                f.y = 510,
                u(f, i, !0);
                var p = new ee("Save your progress!",200,30,"#ffffff",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
                p.anchor.set(.5, 1),
                p.x = 400,
                p.y = 640,
                this.addChild(p)
                ...
                f.y = 510,
                u(f, r, !0);
                var p = new ee("Invite your friends!",200,30,"#ffffff",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
                p.anchor.set(.5, 1),
                p.x = 400,
                p.y = 645,
                this.addChild(p)
            ...
            this.setRatio = function(t) {
                o.width = a.width = 800 * t,
                a.height = 180 * t,
                o.y = a.y = (g.y - 35) * t,
                o.height = 40 * t,
                g.hitArea = new d.Rectangle(-200 * t,0,800 * t,150 * t),
                (i || r) && (c.width = a.width,
                c.height = 155 * t,
                c.y = 520 * t,
                f.hitArea = new d.Rectangle(-200 * t,10 * t,800 * t,150 * t))
            }
            ,
            this.innerHeight = i ? 820 : 640,
            this.blurClose = !1
        };
        ne.prototype = Object.create(m.prototype),
        ...
        var ae = function() {
            function t() {
                s("market://details?id=com.frvr.solitaire"),
                ga("send", "event", "Solitaire", "Android App Install Requested - Level Selector")
            }
            ie.call(this),
            this.createHeadline("Install Game");
            var e = new d.Graphics;
            this.addChild(e),
            e.beginFill(8042350, 1),
            e.drawRoundedRect(0, 0, 800, 180, 35);
            var i = new ee("Install App to unlock all levels!",200,40,"#2c2c2c",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            i.anchor.set(.5, 1),
            i.x = 400,
            i.y = 200,
            this.addChild(i);
            ...
            this.addChild(r),
            r.beginFill(15658734, 1),
            r.drawRect(0, 0, 800, 180);
            ...
            u(a, t, !0),
            this.setRatio = function(t) {
                r.width = e.width = 800 * t,
                e.height = 180 * t,
                r.y = e.y = 680 * t,
                r.height = 40 * t,
                a.hitArea = new d.Rectangle(-200 * t,0,800 * t,150 * t),
                n.scale.set(t, t),
                n.y = 205 * t
            }
            ,
        ...
        var oe = function() {
            function t() {
                s(window.isGoogleAd ? "https://itunes.apple.com/app/apple-store/id911820971?pt=105280809&ct=Google%20AQ%20Ads%20-%20Level%20Selector&mt=8" : "https://itunes.apple.com/app/apple-store/id911820971?pt=105280809&ct=Solitaire%20FRVR%20-%20Level%20Selector&mt=8"),
                ga("send", "event", "Solitaire", "iOS App Install Requested - Level Selector")
            }
            ie.call(this),
            this.createHeadline("Install Game");
            var e = new d.Graphics;
        ...
        var he = function() {
            ie.call(this),
            this.createHeadline("Level is locked");
            var t = new d.Graphics;
            this.addChild(t),
            t.beginFill(8042350, 1),
            t.drawRoundedRect(0, 0, 800, 180, 35);
            var e = new d.Graphics;
            this.addChild(e),
            e.beginFill(15658734, 1),
            e.drawRect(0, 0, 800, 180);
            var i = this.createButton(null, "Ok", !0);
            this.addChild(i),
            i.x = 200,
            i.y = 205;
            var r = new ee("Win previous games to unlock level.",100,40,"#2c2c2c",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            r.anchor.set(.5, 1),
            r.x = 400,
            r.y = 200,
            this.addChild(r),
            this.setRatio = function(r) {
                e.width = t.width = 800 * r,
                t.height = 180 * r,
                e.y = t.y = 170 * r,
                e.height = 40 * r,
                i.hitArea = new d.Rectangle(-200 * r,0,800 * r,150 * r)
            }
            ,
            this.innerHeight = 350
        };
        he.prototype = Object.create(m.prototype),
        he.prototype.constructor = he;
        var le = function(t, e) {
            ie.call(this);
            var i = new d.Graphics;
            this.addChild(i),
            i.beginFill(8042350, 1),
            i.drawRoundedRect(0, 0, 800, 180, 35);
            var r = new d.Graphics;
            this.addChild(r),
            r.beginFill(15658734, 1),
            r.drawRect(0, 0, 800, 180);
            ...
            this.addChild(n);
            var s = new Date(t * ht)
              , a = this.createHeadline("Play Level")
              , o = s.getDate()
              , h = ["", "st", "nd", "rd"][o] || "th"
            ...
            0 > c && (c = -c + "bc");
            var f = o + h + " " + l + " " + c
              , p = new ee(f,200,50,"#2c2c2c",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            p.anchor.set(.5, 0),
            p.x = 400,
            p.y = a.y + a.height + 5,
            this.addChild(p);
            var g = this.createButton(w.fromSheet(iconSheet, 10), "Draw 1 Card");
            this.addChild(g),
            g.y = 275;
            var v = this.createButton(w.fromSheet(iconSheet, 8), "Draw 3 Cards");
            this.addChild(v),
            v.y = 275,
            v.x = 400,
            u(v, function() {
            ...
            this.setRatio = function(t) {
                r.width = i.width = 800 * t,
                i.height = 180 * t,
                r.y = i.y = 240 * t,
                r.height = 40 * t,
                n.y = 275 * t,
                n.clear(),
                n.beginFill(15658734, 1),
                n.drawRect(398 * t, 0, 4 * t, 145 * t),
                g.hitArea = v.hitArea = new d.Rectangle(0,0,400 * t,145 * t)
            }
            ,
        ...
        var ce = function() {
            ...
            this.setHeight = function(t) {
                h = t,
                a.clear(),
                a.beginFill(15658734, 1),
                a.drawRoundedRect(0, 0, o, h, 35),
                this.ratio && this.setRatio(this.ratio)
            }
            ,
            this.setHeight(800),
            this.redraw = function() {
                ge.ratio = Math.min(Math.min(S * C / 900, M * C / (h + 100)), C / 2),
                n.clear(),
                n.beginFill(0, .6),
                n.drawRect(0, 0, S * C, M * C),
                this.reAlign()
            }
            ;
            var l = this;
        ...
        var de = function(t, e, i, r, n, s) {
            m.call(this),
            this.date = new Date(t * ht),
            this.offsetDays = t;
            var a = dt.getTime() == this.date.getTime();
            this.isToday = a,
            s || (this.interactive = !0,
            this.buttonMode = !0);
            ...
            this.addChild(l);
            var c, f = 1;
            a || (c = new ee(["", "st", "nd", "rd"][h] || "th",200,25,"#2c2c2c"),
            c.x = l.x + l.width / 2,
            c.y = l.y,
            this.addChild(c)),
            s || a || (o.scale.set(.5, .5),
            f = .5);
            var g = [[0, -76], [-48, -64], [48, -64]]
              , v = [1, .8, .8]
              , y = []
              , x = 0;
            ...
            this.refresh = function() {
                ...
                o.frame = t ? 1 : 0,
                t ? (b.removeChild(l),
                c && b.removeChild(c)) : (b.addChild(l),
                c && b.addChild(c))
            }
            ,
            this.setRatio = function(t) {
        ...
        var ue = function(t, e) {
            function i(t, e) {
                return t += c,
                Math.sin(t / 250) * Math.cos(t / 700) * Math.min(e / 5, 1)
            }
            function r() {
                F.frame = 1,
                setTimeout(function() {
                    F.frame = 0,
                    setTimeout(r, (15e3 * Math.random() >> 0) + 5e3)
                }, 100)
            }
            m.call(this);
            ...
            G.addChild(F),
            r(),
            this.setStars = function(t, e) {
                for (var i = 0; i < M.length; i++)
                    M[i].offsetDays == t && M[i].setStars(e)
            }
            ,
            this.refresh = function() {
            ...
            this.showSelector = function(t) {
                ...
                for (var e = 0; e < M.length; e++) {
                    ...
                    if (i.offsetDays == t)
                        ...
                        i.y < -100 ? (D.y = i.y + 25,
                        D.rotation = Math.PI,
                        F.y = D.y + 100) : (D.y = i.y - (i.isToday ? 55 : 15),
                        D.rotation = 0,
                        F.y = D.y - 95),
                        !0
                }
            ...
            this.setRatio = function(t) {
                s.clear(),
                s.lineStyle(Math.max(15 * this.ratio >> 0, 1), "0xff8400", 1);
                for (var e = 0; e < x.length; e++) {
                    var i = x[e];
            ...
            this.reAlign = function() {
                for (var e = S / this.ratio * C, i = 0, r = 0; t > r; r++)
                    i += Math.max(ue.dataCache[r].realWidth, e);
                this.x = i,
                o.x = Math.max(0, (e - this.realWidth) / 2),
                O.x = Math.max(e, this.realWidth) - 25,
                G.x = h.x = a.x = o.x,
                s.x = o.x * this.ratio
            }
            ,
            this.realWidth = g + 325,
            ue.dataCache[t + 1] = ue.dataCache[t + 1] || {},
            ue.dataCache[t + 1].dayOffset = b + l,
            ue.dataCache[t + 1].offsetX = c + this.realWidth,
            ue.dataCache[t + 1].offsetY = v,
            ue.dataCache[t].realWidth = this.realWidth
        };
        ...
        var fe = function(t, e) {
            m.call(this),
            e = new Date(dt.getTime() - ue.dataCache[t].dayOffset * ht);
            ...
            var n = isStandalone && (!isMobileiOSDevice || M > S) || window.isiOS && window.isCordova ? 20 * C : 0
              , s = new ee(i,200,100,"#ffffff",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            this.addChild(s),
            s.y = 10 + n,
            s.updateText();
            var a = new ee(r,100,100,"#ffffff",'"Helvetica Neue","Trebuchet MS", Helvetica, sans-serif');
            this.addChild(a),
            a.y = 10 + n + s.height - a.height;
        ...
        var pe = function() {
            function t() {
                var t = a.serialize()
                  , e = a.countCompleted();
                Store.set(window.levelVersion, t),
                a.onSave(t, e)
            }
            function e() {
                var t = 0;
                for (var e in a.state)
                    t++;
                l = t
            }
            function i(t) {
                    ...
                    for (var r = e.split(","), n = 0; n < r.length; n++) {
                        ...
                        2 == s.length) {
                            var o = parseInt(s[1]) || 0
                              , h = this.state[s[0]] || 0;
                            o > h && (this.state[s[0]] = o,
                            i || a.setStarsOffset(s[0], o))
                        }
                    }
                    t(),
                    st && calenderView.centerSelector(1)
                }
            }
            ,
            ...
            this.showSelector = function() {
                for (var t = 0; ; ) {
                    if (0 == (this.state[h - t] || 0))
                        break;
                    t++
                }
                for (var e in y)
                    if (y[e].showSelector(h - t))
                        return y[e];
                return !1
            }
            ,
            ...
            this.show = function(t, e, n) {
                t = Math.max(0, t),
                n || t == this.offset || ga("send", "event", "Solitaire", "Navigating Level Selector"),
                this.offset = t,
                y[t] || i(t),
                x[t] || r(t),
                this.reAlign(!0, e, function() {
                    s(t)
                })
            }
            ,
            ...
            this.setStars = function(e, i) {
                i > (this.state[e] || 0) && (this.state[e] = i),
                this.setStarsOffset(e, i),
                t()
            }
            ,
            ...
            A.touchmove = function(t) {
                if (null != u) {
                    ...
                    if (Math.abs(i) > 25 || v) {
                        ...
                        var r = f + i;
                        g = (d.x - r) * a.ratio,
                        r > 0 && (r = Math.min(10 * Math.sqrt(r), r)),
                        d.x = r
                    }
                }
            }
            ...
            n(function(t) {
                if (u) {
                    ...
                    if (d.x < n) {
                        if (n - d.x > i || g > 15)
                            return void a.show(a.offset + 1)
                    } else if (d.x > r && (-y[a.offset].x - d.x < -i || -15 > g))
                        return void a.show(a.offset - 1);
        ...
        pe.prototype = Object.create(m.prototype),
        pe.prototype.constructor = pe;
        var ge = new ce;
        window.calenderView = new pe,
        window.onresize = function(t) {
            clearTimeout(Yt),
            t === !0 ? j() : Yt = setTimeout(j, 20)
        }
        ,
        B.addChild(qt),
        window.showLevelSelector = function() {
            ...
            ge.hide(function() {
                H(),
                B.addChild(calenderView),
                calenderView.centerSelector(1),
                t()
            })
        }
        ,
        window.showAndroidInstallBanner = X,
        window.showiOSInstallBanner = q,
        window.onresize(!0),
        setTimeout(function() {
            Store.get(window.levelVersion) && !Store.get(window.storeVersion) ? showLevelSelector() : (F(!0),
            B.addChild(gt),
            B.addChild(Et),
            B.addChild(Rt))
        }, 1)
    ...
    d._UID = 0,
    "undefined" != typeof Float32Array ? (d.Float32Array = Float32Array,
    d.Uint16Array = Uint16Array,
    d.Uint32Array = Uint32Array,
    d.ArrayBuffer = ArrayBuffer) : (d.Float32Array = Array,
    d.Uint16Array = Array),
    d.INTERACTION_FREQUENCY = 30,
    d.AUTO_PREVENT_DEFAULT = !0,
    d.PI_2 = 2 * Math.PI,
    d.RAD_TO_DEG = 180 / Math.PI,
    ...
    d.sayHello = function(t) {
        if (!d.dontSayHello) {
            if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
                ...
                window.console && console.log("Pixi.js " + d.VERSION + " - http://www.pixijs.com/");
            d.dontSayHello = !0
        }
    }
    ,
    ...
    ,
    d.Point.prototype.constructor = d.Point,
    d.Rectangle = function(t, e, i, r) {
        this.x = t || 0,
        this.y = e || 0,
        this.width = i || 0,
        this.height = r || 0
    ...
    d.Rectangle.prototype.contains = function(t, e) {
        ...
        if (t >= i && t <= i + this.width) {
            var r = this.y;
            if (e >= r && e <= r + this.height)
                return !0
        }
        return !1
    }
    ,
    d.Rectangle.prototype.constructor = d.Rectangle,
    d.EmptyRectangle = new d.Rectangle(0,0,0,0),
    d.Polygon = function(t) {
        if (t instanceof Array || (t = Array.prototype.slice.call(arguments)),
        t[0]instanceof d.Point) {
    ...
    ,
    d.Circle.prototype.constructor = d.Circle,
    ...
    ,
    d.Ellipse.prototype.constructor = d.Ellipse,
    d.RoundedRectangle = function(t, e, i, r, n) {
        this.x = t || 0,
        this.y = e || 0,
        this.width = i || 0,
        this.height = r || 0,
    ...
    ,
    d.RoundedRectangle.prototype.constructor = d.RoundedRectangle,
    d.Matrix = function() {
        this.a = 1,
        this.b = 0,
        this.c = 0,
    ...
    d.DisplayObject = function() {
        ...
        this._bounds = new d.Rectangle(0,0,1,1),
    ...
    ,
    d.DisplayObject.prototype.constructor = d.DisplayObject,
    ...
    d.DisplayObject.prototype.updateTransform = function() {
        var t, e, i, r, n, s, a = this.parent.worldTransform, o = this.worldTransform;
        this.rotation % d.PI_2 ? (this.rotation !== this.rotationCache && (this.rotationCache = this.rotation,
        ...
        s -= this.pivot.x * e + this.pivot.y * r),
        o.a = t * a.a + e * a.c,
        o.b = t * a.b + e * a.d,
        o.c = i * a.a + r * a.c,
        o.d = i * a.b + r * a.d,
        o.tx = n * a.a + s * a.c + a.tx,
        o.ty = n * a.b + s * a.d + a.ty) : (t = this.scale.x,
        r = this.scale.y,
        n = this.position.x - this.pivot.x * t,
        s = this.position.y - this.pivot.y * r,
        o.a = t * a.a,
        o.b = t * a.b,
        o.c = r * a.c,
        o.d = r * a.d,
        o.tx = n * a.a + s * a.c + a.tx,
        o.ty = n * a.b + s * a.d + a.ty),
        this.worldAlpha = this.alpha * this.parent.worldAlpha
    }
    ,
    d.DisplayObject.prototype.displayObjectUpdateTransform = d.DisplayObject.prototype.updateTransform,
    d.DisplayObject.prototype.getBounds = function(t) {
        return t = t,
        d.EmptyRectangle
    }
    ,
    ...
    d.DisplayObject.prototype.generateTexture = function(t, e, i) {
        ...
        return d.DisplayObject._tempMatrix.tx = -r.x,
        d.DisplayObject._tempMatrix.ty = -r.y,
        n.render(this, d.DisplayObject._tempMatrix),
        n
    }
    ,
    ...
    d.DisplayObject.prototype._renderCachedSprite = function(t) {
        ...
        t.gl ? d.Sprite.prototype._renderWebGL.call(this._cachedSprite, t) : d.Sprite.prototype._renderCanvas.call(this._cachedSprite, t)
    }
    ,
    d.DisplayObject.prototype._generateCachedSprite = function() {
        ...
        if (this._cachedSprite)
            ...
            this._cachedSprite = new d.Sprite(e),
            this._cachedSprite.worldTransform = this.worldTransform
        }
        var i = this._filters;
        this._filters = null,
        this._cachedSprite.filters = i,
        d.DisplayObject._tempMatrix.tx = -t.x,
        d.DisplayObject._tempMatrix.ty = -t.y,
        this._cachedSprite.texture.render(this, d.DisplayObject._tempMatrix, !0),
    ...
    ,
    d.DisplayObject._tempMatrix = new d.Matrix,
    ...
    d.DisplayObjectContainer = function() {
        d.DisplayObject.call(this),
        this.children = []
    }
    ,
    d.DisplayObjectContainer.prototype = Object.create(d.DisplayObject.prototype),
    d.DisplayObjectContainer.prototype.constructor = d.DisplayObjectContainer,
    Object.defineProperty(d.DisplayObjectContainer.prototype, "width", {
        get: function() {
    ...
    ,
    d.DisplayObjectContainer.prototype.displayObjectContainerUpdateTransform = d.DisplayObjectContainer.prototype.updateTransform,
    d.DisplayObjectContainer.prototype.getBounds = function() {
        if (0 === this.children.length)
            return d.EmptyRectangle;
        for (var t, e, i, r = 1 / 0, n = 1 / 0, s = -(1 / 0), a = -(1 / 0), o = !1, h = 0, l = this.children.length; l > h; h++) {
            var c = this.children[h];
            c.visible && (o = !0,
            t = this.children[h].getBounds(),
            r = r < t.x ? r : t.x,
            n = n < t.y ? n : t.y,
            e = t.width + t.x,
            i = t.height + t.y,
    ...
    d.DisplayObjectContainer.prototype._renderWebGL = function(t) {
        if (this.visible && !(this.alpha <= 0)) {
            ...
            if (this._mask || this._filters) {
                for (this._mask && (t.spriteBatch.stop(),
    ...
    d.Sprite = function(t) {
        ...
        this.texture = t || d.Texture.emptyTexture,
        this._width = 0,
        this._height = 0,
        this.tint = 16777215,
        this.blendMode = d.blendModes.NORMAL,
        this.shader = null,
    ...
    d.Sprite.prototype._renderCanvas = function(t) {
        if (!(this.visible === !1 || 0 === this.alpha || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            t.context.globalCompositeOperation = d.blendModesCanvas[t.currentBlendMode]),
            this._mask && t.maskManager.pushMask(this._mask, t),
            this.texture.valid) {
                ...
                t.context[t.smoothProperty] = t.scaleMode === d.scaleModes.LINEAR);
                ...
                t.roundPixels ? (t.context.setTransform(this.worldTransform.a, this.worldTransform.b, this.worldTransform.c, this.worldTransform.d, this.worldTransform.tx * t.resolution | 0, this.worldTransform.ty * t.resolution | 0),
                i = 0 | i,
                r = 0 | r) : t.context.setTransform(this.worldTransform.a, this.worldTransform.b, this.worldTransform.c, this.worldTransform.d, this.worldTransform.tx * t.resolution, this.worldTransform.ty * t.resolution),
                16777215 !== this.tint ? (this.cachedTint !== this.tint && (this.cachedTint = this.tint,
                this.tintedTexture = d.CanvasTinter.getTintedTexture(this, this.tint)),
                t.context.drawImage(this.tintedTexture, 0, 0, this.texture.crop.width, this.texture.crop.height, i / e, r / e, this.texture.crop.width / e, this.texture.crop.height / e)) : t.context.drawImage(this.texture.baseTexture.source, this.texture.crop.x, this.texture.crop.y, this.texture.crop.width, this.texture.crop.height, i / e, r / e, this.texture.crop.width / e, this.texture.crop.height / e)
            }
            for (var n = 0, s = this.children.length; s > n; n++)
    ...
    ,
    d.SpriteBatch.prototype = Object.create(d.DisplayObjectContainer.prototype),
    d.SpriteBatch.prototype.constructor = d.SpriteBatch,
    d.SpriteBatch.prototype.initWebGL = function(t) {
        this.fastSpriteBatch = new d.WebGLFastSpriteBatch(t),
        this.ready = !0
    }
    ,
        ...
        if (this.visible && !(this.alpha <= 0) && this.children.length) {
            ...
            for (var i = this.worldTransform, r = !0, n = 0; n < this.children.length; n++) {
                ...
                if (s.visible) {
                    var a = s.texture
                      , o = a.frame;
                    if (e.globalAlpha = this.worldAlpha * s.alpha,
                    s.rotation % (2 * Math.PI) === 0)
                        r && (e.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty),
                        r = !1),
                        e.drawImage(a.baseTexture.source, o.x, o.y, o.width, o.height, s.anchor.x * -o.width * s.scale.x + s.position.x + .5 | 0, s.anchor.y * -o.height * s.scale.y + s.position.y + .5 | 0, o.width * s.scale.x, o.height * s.scale.y);
                    else {
                        r || (r = !0),
                        ...
                        e.drawImage(a.baseTexture.source, o.x, o.y, o.width, o.height, s.anchor.x * -o.width + .5 | 0, s.anchor.y * -o.height + .5 | 0, o.width, o.height)
                    }
                }
            }
        }
    ...
    d.Text = function(t, e) {
        ...
        this.resolution = 1,
        d.Sprite.call(this, d.Texture.fromCanvas(this.canvas)),
        this.setText(t),
        this.setStyle(e)
    }
    ,
    d.Text.prototype = Object.create(d.Sprite.prototype),
    d.Text.prototype.constructor = d.Text,
    Object.defineProperty(d.Text.prototype, "width", {
        get: function() {
    ...
    d.Text.prototype.updateText = function() {
        ...
        if (this.style.dropShadow) {
            ...
            for (s = 0; s < e.length; s++)
                c = this.style.strokeThickness / 2,
                d = this.style.strokeThickness / 2 + s * h + n.ascent,
                "right" === this.style.align ? c += r - i[s] : "center" === this.style.align && (c += (r - i[s]) / 2),
                this.style.fill && this.context.fillText(e[s], c + u, d + f)
        }
        ...
        s = 0; s < e.length; s++)
            ...
            d = this.style.strokeThickness / 2 + s * h + n.ascent,
            "right" === this.style.align ? c += r - i[s] : "center" === this.style.align && (c += (r - i[s]) / 2),
            this.style.stroke && this.style.strokeThickness && this.context.strokeText(e[s], c, d),
            this.style.fill && this.context.fillText(e[s], c, d);
        this.updateTexture()
    }
    ,
    ...
    d.Text.prototype._renderWebGL = function(t) {
        this.dirty && (this.resolution = t.resolution,
        this.updateText(),
        this.dirty = !1),
        d.Sprite.prototype._renderWebGL.call(this, t)
    }
    ...
    d.Text.prototype._renderCanvas = function(t) {
        ...
        this.updateText(),
        this.dirty = !1),
        d.Sprite.prototype._renderCanvas.call(this, t)
    }
    ,
    d.Text.prototype.determineFontProperties = function(t) {
        ...
        if (!e) {
            ...
            r.fillStyle = "#888888",
            r.fillText("|MÉq", 0, s);
            var o, h, l = r.getImageData(0, 0, n, a).data, c = l.length, u = 4 * n, f = 0, p = !1;
            for (o = 0; s > o; o++) {
                for (h = 0; u > h; h += 4)
                    if (255 !== l[f + h]) {
                        p = !0;
            ...
            d.Text.fontPropertiesCache[t] = e
        }
        return e
    }
    ,
    d.Text.prototype.wordWrap = function(t) {
        for (var e = "", i = t.split("\n"), r = 0; r < i.length; r++) {
            for (var n = this.style.wordWrapWidth, s = i[r].split(" "), a = 0; a < s.length; a++) {
                ...
                0 === a || h > n ? (a > 0 && (e += "\n"),
                e += s[a],
                n = this.style.wordWrapWidth - o) : (n -= h,
                e += " " + s[a])
            }
            r < i.length - 1 && (e += "\n")
        }
    ...
    d.Text.prototype.getBounds = function(t) {
        return this.dirty && (this.updateText(),
        this.dirty = !1),
        d.Sprite.prototype.getBounds.call(this, t)
    }
    ,
    ...
    ,
    d.Text.fontPropertiesCache = {},
    d.Text.fontPropertiesCanvas = document.createElement("canvas"),
    d.Text.fontPropertiesContext = d.Text.fontPropertiesCanvas.getContext("2d"),
    d.InteractionData = function() {
        this.global = new d.Point,
        this.target = null,
    ...
    d.InteractionData.prototype.getLocalPosition = function(t, e) {
        var i = t.worldTransform
          ...
          , c = 1 / (n * h + s * -o);
        return e = e || new d.Point,
        e.x = h * c * r.x + -s * c * r.y + (l * s - a * h) * c,
        e.y = n * c * r.y + -o * c * r.x + (-l * n + a * o) * c,
        e
    }
    ,
    d.InteractionData.prototype.constructor = d.InteractionData,
    d.InteractionManager = function(t) {
        this.stage = t,
        this.mouse = new d.InteractionData,
        this.touches = {},
        this.tempPoint = new d.Point,
    ...
    ,
    d.InteractionManager.prototype.constructor = d.InteractionManager,
    d.InteractionManager.prototype.collectInteractiveSprite = function(t, e) {
        for (var i = t.children, r = i.length, n = r - 1; n >= 0; n--) {
            var s = i[n];
            s._interactive ? (e.interactiveChildren = !0,
            this.interactiveItems.push(s),
            s.children.length > 0 && this.collectInteractiveSprite(s, s)) : (s.__iParent = null,
            s.children.length > 0 && this.collectInteractiveSprite(s, e))
        }
    }
    ,
    ...
    d.InteractionManager.prototype.setTargetDomElement = function(t) {
        this.removeEvents(),
        window.navigator.msPointerEnabled && (t.style["-ms-content-zooming"] = "none",
    ...
    d.InteractionManager.prototype.update = function() {
        if (this.target) {
            var t = Date.now()
              , e = t - this.last;
            if (e = e * d.INTERACTION_FREQUENCY / 1e3,
            !(1 > e)) {
                this.last = t;
                var i = 0;
                ...
                for (i = 0; r > i; i++) {
                    ...
                    this.mouse.target = a,
                    a.__hit && !s ? (a.buttonMode && (n = a.defaultCursor),
                    a.interactiveChildren || (s = !0),
                    a.__isOver || (a.mouseover && a.mouseover(this.mouse),
                    a.__isOver = !0)) : a.__isOver && (a.mouseout && a.mouseout(this.mouse),
                    a.__isOver = !1)
                }
                this.currentCursorStyle !== n && (this.currentCursorStyle = n,
    ...
    d.InteractionManager.prototype.rebuildInteractiveGraph = function() {
        this.dirty = !1;
        for (var t = this.interactiveItems.length, e = 0; t > e; e++)
    ...
    d.InteractionManager.prototype.onMouseDown = function(t) {
        this.dirty && this.rebuildInteractiveGraph(),
        this.mouse.originalEvent = t,
        d.AUTO_PREVENT_DEFAULT && this.mouse.originalEvent && this.mouse.originalEvent.preventDefault();
    ...
    d.InteractionManager.prototype.onMouseOut = function(t) {
        ...
        for (var i = 0; e > i; i++) {
            ...
            r.__isOver && (this.mouse.target = r,
            r.mouseout && r.mouseout(this.mouse),
            r.__isOver = !1)
        }
        this.mouseOut = !0,
    ...
    d.InteractionManager.prototype.onMouseUp = function(t) {
        ...
        for (var e = this.interactiveItems.length, i = !1, r = this.mouse.originalEvent, n = 2 === r.button || 3 === r.which, s = n ? "rightup" : "mouseup", a = n ? "rightclick" : "click", o = n ? "rightupoutside" : "mouseupoutside", h = n ? "__isRightDown" : "__isDown", l = 0; e > l; l++) {
            ...
            (c[a] || c[s] || c[o]) && (c.__hit = this.hitTest(c, this.mouse),
            c.__hit && !i ? (c[s] && c[s](this.mouse),
            c[h] && c[a] && c[a](this.mouse),
            c.interactiveChildren || (i = !0)) : c[h] && c[o] && c[o](this.mouse),
            c[h] = !1)
        }
    }
    ,
    d.InteractionManager.prototype.hitTest = function(t, e) {
        ...
        var r, n = this._tempPoint.x, s = this._tempPoint.y;
        if (e.target = t,
        t.hitArea && t.hitArea.contains)
            return t.hitArea.contains(n, s);
        if (t instanceof d.Sprite) {
            var a, o = t.texture.frame.width, h = t.texture.frame.height, l = -o * t.anchor.x;
            if (n > l && l + o > n && (a = -h * t.anchor.y,
            s > a && a + h > s))
                return !0
            ...
            for (r = 0; r < c.length; r++) {
                var u = c[r];
                if (u.fill && u.shape && u.shape.contains(n, s))
                    return !0
            }
        }
    ...
    d.InteractionManager.prototype.onTouchMove = function(t) {
        this.dirty && this.rebuildInteractiveGraph();
        var e, i = this.interactionDOMElement.getBoundingClientRect(), r = t.changedTouches, n = 0;
        for (n = 0; n < r.length; n++) {
            var s = r[n];
            e = this.touches[s.identifier],
            e.originalEvent = t,
            e.global.x = (s.clientX - i.left) * (this.target.width / i.width) / this.resolution,
            e.global.y = (s.clientY - i.top) * (this.target.height / i.height) / this.resolution;
    ...
    d.InteractionManager.prototype.onTouchStart = function(t) {
        ...
        for (var i = t.changedTouches, r = 0; r < i.length; r++) {
            var n = i[r]
              , s = this.pool.pop();
            s || (s = new d.InteractionData),
            s.originalEvent = t,
            this.touches[n.identifier] = s,
            s.global.x = (n.clientX - e.left) * (this.target.width / e.width) / this.resolution,
            s.global.y = (n.clientY - e.top) * (this.target.height / e.height) / this.resolution;
            for (var a = this.interactiveItems.length, o = 0; a > o; o++) {
                var h = this.interactiveItems[o];
                if ((h.touchstart || h.tap) && (h.__hit = this.hitTest(h, s),
                h.__hit && (h.touchstart && h.touchstart(s),
                h.__isDown = !0,
                h.__touchData = h.__touchData || {},
                h.__touchData[n.identifier] = s,
                !h.interactiveChildren)))
                    break
            }
        }
    }
    ...
    d.InteractionManager.prototype.onTouchEnd = function(t) {
        ...
        for (var e = this.interactionDOMElement.getBoundingClientRect(), i = t.changedTouches, r = 0; r < i.length; r++) {
            ...
            for (var o = this.interactiveItems.length, h = 0; o > h; h++) {
                var l = this.interactiveItems[h];
                l.__touchData && l.__touchData[n.identifier] && (l.__hit = this.hitTest(l, l.__touchData[n.identifier]),
                s.originalEvent = t,
                (l.touchend || l.tap) && (l.__hit && !a ? (l.touchend && l.touchend(s),
                l.__isDown && l.tap && l.tap(s),
                l.interactiveChildren || (a = !0)) : l.__isDown && l.touchendoutside && l.touchendoutside(s),
                l.__isDown = !1),
                l.__touchData[n.identifier] = null)
            }
            this.pool.push(s),
    ...
    d.Stage = function(t) {
        ...
        this.worldTransform = new d.Matrix,
        this.interactive = !0,
        this.interactionManager = new d.InteractionManager(this),
        this.dirty = !0,
        this.stage = this,
        this.stage.hitArea = new d.Rectangle(0,0,1e5,1e5),
        this.setBackgroundColor(t)
    }
    ,
    d.Stage.prototype = Object.create(d.DisplayObjectContainer.prototype),
    d.Stage.prototype.constructor = d.Stage,
    d.Stage.prototype.setInteractionDelegate = function(t) {
    ...
    d.Stage.prototype.setBackgroundColor = function(t) {
        ...
        this.backgroundColorSplit = d.hex2rgb(this.backgroundColor);
    ...
    "function" != typeof Function.prototype.bind && (Function.prototype.bind = function() {
        return function(t) {
            function e() {
                for (var r = arguments.length, s = new Array(r); r--; )
                    s[r] = arguments[r];
                return s = n.concat(s),
                i.apply(this instanceof e ? this : t, s)
            }
            var i = this
            ...
            return e.prototype = function s(t) {
                return t && (s.prototype = t),
                this instanceof s ? void 0 : new s
            }(i.prototype),
            e
        }
    }()),
    ...
    ,
    d.PolyK = {},
    d.PolyK.Triangulate = function(t) {
        var e = !0
          , i = t.length >> 1;
        if (3 > i)
            return [];
        for (var r = [], n = [], s = 0; i > s; s++)
            n.push(s);
        s = 0;
        for (var a = i; a > 3; ) {
            var o = n[(s + 0) % a]
    ...
    d.EventTarget = {
        ...
        mixin: function(t) {
            ...
            t.emit = t.dispatchEvent = function(t, e) {
                ...
                "object" == typeof t && (e = t,
                t = t.type),
                e && e.__isEventObject === !0 || (e = new d.Event(this,t,e)),
                this._listeners && this._listeners[t]) {
                    var i, r = this._listeners[t].slice(0), n = r.length, s = r[0];
                    for (i = 0; n > i; s = r[++i])
                        if (s.call(this, e),
                        e.stoppedImmediate)
                            return this;
    ...
    ,
    d.initDefaultShaders = function() {}
    ,
    d.CompileVertexShader = function(t, e) {
    ...
    d.compileProgram = function(t, e, i) {
        ...
        t.attachShader(s, r),
        t.linkProgram(s),
        t.getProgramParameter(s, t.LINK_STATUS) || window.console.log("Could not initialise shaders"),
        s
    }
    ,
    ...
    ,
    d.PixiShader.prototype.constructor = d.PixiShader,
    ...
    d.PixiShader.prototype.initUniforms = function() {
        ...
        for (var i in this.uniforms) {
            ...
            "2f" === r || "2i" === r ? t.glValueLength = 2 : "3f" === r || "3i" === r ? t.glValueLength = 3 : "4f" === r || "4i" === r ? t.glValueLength = 4 : t.glValueLength = 1)
        }
    }
    ,
    ...
    d.PixiShader.prototype.syncUniforms = function() {
        ...
        for (var i in this.uniforms)
            ...
            t.value.baseTexture._dirty[e.id] ? d.instances[e.id].updateTexture(t.value.baseTexture) : e.bindTexture(e.TEXTURE_2D, t.value.baseTexture._glTextures[e.id]),
            e.uniform1i(t.uniformLocation, this.textureCount),
    ...
    ,
    d.PixiFastShader.prototype.constructor = d.PixiFastShader,
    ...
    ,
    d.StripShader.prototype.constructor = d.StripShader,
    ...
    ,
    d.PrimitiveShader.prototype.constructor = d.PrimitiveShader,
    ...
    ,
    d.ComplexPrimitiveShader.prototype.constructor = d.ComplexPrimitiveShader,
    ...
    ,
    d.WebGLGraphics = function() {}
    ,
    d.WebGLGraphics.renderGraphics = function(t, e) {
        var i, r = e.gl, n = e.projection, s = e.offset, a = e.shaderManager.primitiveShader;
        t.dirty && d.WebGLGraphics.updateGraphics(t, r);
        for (var o = t._webGL[r.id], h = 0; h < o.data.length; h++)
            1 === o.data[h].mode ? (i = o.data[h],
            e.stencilManager.pushStencil(t, i, e),
            r.drawElements(r.TRIANGLE_FAN, 4, r.UNSIGNED_SHORT, 2 * (i.indices.length - 4)),
            e.stencilManager.popStencil(t, i, e)) : (i = o.data[h],
            e.shaderManager.setShader(a),
            a = e.shaderManager.primitiveShader,
            r.uniformMatrix3fv(a.translationMatrix, !1, t.worldTransform.toArray(!0)),
            r.uniform1f(a.flipY, 1),
            r.uniform2f(a.projectionVector, n.x, -n.y),
            r.uniform2f(a.offsetVector, -s.x, -s.y),
            r.uniform3fv(a.tintColor, d.hex2rgb(t.tint)),
            r.uniform1f(a.alpha, t.worldAlpha),
    ...
    d.WebGLGraphics.updateGraphics = function(t, e) {
        ...
        if (t.clearDirty) {
            ...
            r = 0; r < i.data.length; r++) {
                var n = i.data[r];
                n.reset(),
                d.WebGLGraphics.graphicsDataPool.push(n)
            }
            i.data = [],
            i.lastIndex = 0
        }
            ...
            if (a.type === d.Graphics.POLY) {
                ...
                a.fill && a.points.length >= 6)
                    if (a.points.length < 12) {
                        ...
                        o || (s = d.WebGLGraphics.switchMode(i, 1),
                        d.WebGLGraphics.buildComplexPoly(a, s))
                    } else
                        s = d.WebGLGraphics.switchMode(i, 1),
                        d.WebGLGraphics.buildComplexPoly(a, s);
                a.lineWidth > 0 && (s = d.WebGLGraphics.switchMode(i, 0),
                d.WebGLGraphics.buildLine(a, s))
            } else
                s = d.WebGLGraphics.switchMode(i, 0),
                a.type === d.Graphics.RECT ? d.WebGLGraphics.buildRectangle(a, s) : a.type === d.Graphics.CIRC || a.type === d.Graphics.ELIP ? d.WebGLGraphics.buildCircle(a, s) : a.type === d.Graphics.RREC && d.WebGLGraphics.buildRoundedRectangle(a, s);
            i.lastIndex++
        }
    ...
    d.WebGLGraphics.switchMode = function(t, e) {
        ...
        (i.mode !== e || 1 === e) && (i = d.WebGLGraphics.graphicsDataPool.pop() || new d.WebGLGraphicsData(t.gl),
        i.mode = e,
        t.data.push(i))) : (i = d.WebGLGraphics.graphicsDataPool.pop() || new d.WebGLGraphicsData(t.gl),
        i.mode = e,
        t.data.push(i)),
        i.dirty = !0,
        i
    ...
    d.WebGLGraphics.buildRectangle = function(t, e) {
        ...
        if (t.lineWidth) {
            var v = t.points;
            t.points = [r, n, r + s, n, r + s, n + a, r, n + a, r, n],
            d.WebGLGraphics.buildLine(t, e),
            t.points = v
        }
    }
    ,
    d.WebGLGraphics.buildRoundedRectangle = function(t, e) {
        var i = t.shape
          ...
          , h = [];
        if (h.push(r, n + o),
        h = h.concat(d.WebGLGraphics.quadraticBezierCurve(r, n + a - o, r, n + a, r + o, n + a)),
        h = h.concat(d.WebGLGraphics.quadraticBezierCurve(r + s - o, n + a, r + s, n + a, r + s, n + a - o)),
        h = h.concat(d.WebGLGraphics.quadraticBezierCurve(r + s, n + o, r + s, n, r + s - o, n)),
        h = h.concat(d.WebGLGraphics.quadraticBezierCurve(r + o, n, r, n, r, n + o)),
        t.fill) {
    ...
    d.WebGLGraphics.quadraticBezierCurve = function(t, e, i, r, n, s) {
        ...
        for (var o, h, l, c, d, u, f = 20, p = [], g = 0, v = 0; f >= v; v++)
            g = v / f,
            o = a(t, i, g),
            h = a(e, r, g),
            l = a(i, n, g),
    ...
    d.WebGLGraphics.buildCircle = function(t, e) {
        var i, r, n = t.shape, s = n.x, a = n.y;
        t.type === d.Graphics.CIRC ? (i = n.radius,
        r = n.radius) : (i = n.width,
        r = n.height);
        var o = 40
          , h = 2 * Math.PI / o
          , l = 0;
        if (t.fill) {
            ...
            l = 0; o + 1 > l; l++)
                v.push(s, a, f, p, g, u),
                v.push(s + Math.sin(h * l) * i, a + Math.cos(h * l) * r, f, p, g, u),
                m.push(y++, y++);
            m.push(y - 1)
        }
        if (t.lineWidth) {
            ...
            for (t.points = [],
            l = 0; o + 1 > l; l++)
                t.points.push(s + Math.sin(h * l) * i, a + Math.cos(h * l) * r);
            d.WebGLGraphics.buildLine(t, e),
            t.points = x
        }
    }
    ...
    d.WebGLGraphics.buildLine = function(t, e) {
        ...
        if (0 !== r.length) {
            ...
            var h, l, c, u, f, p, g, v, m, y, x, w, b, T, C, S, M, E, R, _, A, L, B, P = e.points, G = e.indices, D = r.length / 2, F = r.length, O = P.length / 6, I = t.lineWidth / 2, U = d.hex2rgb(t.lineColor), W = t.lineAlpha, N = U[0] * W, k = U[1] * W, j = U[2] * W;
            for (c = r[0],
            u = r[1],
            f = r[2],
            p = r[3],
            ...
            i = 1; D - 1 > i; i++)
                ...
                A = C * R - E * S,
                Math.abs(A) < .1 ? (A += 10.1,
                P.push(f - m, p - y, N, k, j, W),
                P.push(f + m, p + y, N, k, j, W)) : (h = (S * _ - R * M) / A,
                l = (E * M - C * _) / A,
                L = (h - f) * (h - f) + (l - p) + (l - p),
                L > 19600 ? (b = m - x,
                T = y - w,
    ...
    d.WebGLGraphics.buildComplexPoly = function(t, e) {
        ...
        if (!(i.length < 6)) {
            ...
            e.points = i,
            e.alpha = t.fillAlpha,
            e.color = d.hex2rgb(t.fillColor);
            for (var n, s, a = 1 / 0, o = -(1 / 0), h = 1 / 0, l = -(1 / 0), c = 0; c < i.length; c += 2)
                n = i[c],
                s = i[c + 1],
                a = a > n ? n : a,
                o = n > o ? n : o,
    ...
    d.WebGLGraphics.buildPoly = function(t, e) {
        ...
        if (!(i.length < 6)) {
            ...
            for (p = 0; p < u.length; p += 3)
                ...
                n.push(u[p + 2] + f);
            for (p = 0; s > p; p++)
                r.push(i[2 * p], i[2 * p + 1], h, l, c, o);
            return !0
        }
    }
    ,
    d.WebGLGraphics.graphicsDataPool = [],
    d.WebGLGraphicsData = function(t) {
        this.gl = t,
        this.color = [0, 0, 0],
        this.points = [],
        this.indices = [],
    ...
    d.glContexts = [],
    d.instances = [],
    d.WebGLRenderer = function(t, e, i) {
        if (i)
            for (var r in d.defaultRenderOptions)
                "undefined" == typeof i[r] && (i[r] = d.defaultRenderOptions[r]);
        else
            i = d.defaultRenderOptions;
        d.defaultRenderer || (d.sayHello("webGL"),
        d.defaultRenderer = this),
        this.type = d.WEBGL_RENDERER,
        ...
        this.projection = new d.Point,
        this.offset = new d.Point(0,0),
        this.shaderManager = new d.WebGLShaderManager,
        this.spriteBatch = new d.WebGLSpriteBatch,
        this.maskManager = new d.WebGLMaskManager,
        this.filterManager = new d.WebGLFilterManager,
        this.stencilManager = new d.WebGLStencilManager,
        this.blendModeManager = new d.WebGLBlendModeManager,
        this.renderSession = {
            roundPixels: !0
        },
    ...
    ,
    d.WebGLRenderer.prototype.constructor = d.WebGLRenderer,
    d.WebGLRenderer.prototype.initContext = function() {
        ...
        this.glContextId = t.id = d.WebGLRenderer.glContextId++,
        d.glContexts[this.glContextId] = t,
        d.instances[this.glContextId] = this,
    ...
    d.WebGLRenderer.prototype.render = function(t) {
        if (!this.contextLost) {
            this.__stage !== t && (t.interactive && t.interactionManager.removeEvents(),
            this.__stage = t),
            t.updateTransform();
            var e = this.gl;
            t._interactiveEventsAdded || (t._interactiveEventsAdded = !0,
    ...
    d.WebGLRenderer.prototype.renderDisplayObject = function(t, e, i) {
        this.renderSession.blendModeManager.setBlendMode(d.blendModes.NORMAL),
        this.renderSession.drawCount = 0,
    ...
    d.WebGLRenderer.prototype.updateTexture = function(t) {
        if (t.hasLoaded) {
            ...
            e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, t.scaleMode === d.scaleModes.LINEAR ? e.LINEAR : e.NEAREST),
            t.mipmap && d.isPowerOfTwo(t.width, t.height) ? (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, t.scaleMode === d.scaleModes.LINEAR ? e.LINEAR_MIPMAP_LINEAR : e.NEAREST_MIPMAP_NEAREST),
            e.generateMipmap(e.TEXTURE_2D)) : e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, t.scaleMode === d.scaleModes.LINEAR ? e.LINEAR : e.NEAREST),
    ...
    d.WebGLRenderer.prototype.destroy = function() {
        ...
        d.glContexts[this.glContextId] = null,
    ...
    d.WebGLRenderer.prototype.mapBlendModes = function() {
        var t = this.gl;
        d.blendModesWebGL || (d.blendModesWebGL = [],
        d.blendModesWebGL[d.blendModes.NORMAL] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.ADD] = [t.SRC_ALPHA, t.DST_ALPHA],
        d.blendModesWebGL[d.blendModes.MULTIPLY] = [t.DST_COLOR, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.SCREEN] = [t.SRC_ALPHA, t.ONE],
        d.blendModesWebGL[d.blendModes.OVERLAY] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.DARKEN] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.LIGHTEN] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.COLOR_DODGE] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.COLOR_BURN] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.HARD_LIGHT] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.SOFT_LIGHT] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.DIFFERENCE] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.EXCLUSION] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.HUE] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.SATURATION] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.COLOR] = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        d.blendModesWebGL[d.blendModes.LUMINOSITY] = [t.ONE, t.ONE_MINUS_SRC_ALPHA])
    }
    ,
    d.WebGLRenderer.glContextId = 0,
    d.WebGLBlendModeManager = function() {
        this.currentBlendMode = 99999
    }
    ,
    d.WebGLBlendModeManager.prototype.constructor = d.WebGLBlendModeManager,
    d.WebGLBlendModeManager.prototype.setContext = function(t) {
        this.gl = t
    }
    ,
    ...
    ,
    d.WebGLMaskManager = function() {}
    ,
    d.WebGLMaskManager.prototype.constructor = d.WebGLMaskManager,
    d.WebGLMaskManager.prototype.setContext = function(t) {
        this.gl = t
    }
    ,
    d.WebGLMaskManager.prototype.pushMask = function(t, e) {
        var i = e.gl;
        t.dirty && d.WebGLGraphics.updateGraphics(t, i),
    ...
    d.WebGLStencilManager.prototype.pushStencil = function(t, e, i) {
        ...
        this.reverse ? (r.stencilFunc(r.EQUAL, 255 - n, 255),
        ...
        this.reverse ? r.stencilFunc(r.EQUAL, 255 - (n + 1), 255) : r.stencilFunc(r.EQUAL, n + 1, 255),
        this.reverse = !this.reverse) : (this.reverse ? (r.stencilFunc(r.EQUAL, n, 255),
        ...
        this.reverse ? r.stencilFunc(r.EQUAL, n + 1, 255) : r.stencilFunc(r.EQUAL, 255 - (n + 1), 255)),
        r.colorMask(!0, !0, !0, !0),
    ...
    d.WebGLStencilManager.prototype.bindGraphics = function(t, e, i) {
        ...
        var r, n = this.gl, s = i.projection, a = i.offset;
        ...
        n.uniform2f(r.projectionVector, s.x, -s.y),
        n.uniform2f(r.offsetVector, -a.x, -a.y),
        n.uniform3fv(r.tintColor, d.hex2rgb(t.tint)),
    ...
    d.WebGLStencilManager.prototype.popStencil = function(t, e, i) {
        ...
        0 === this.stencilStack.length)
            ...
            this.reverse ? (r.stencilFunc(r.EQUAL, 255 - (n + 1), 255),
            ...
            this.reverse ? r.stencilFunc(r.EQUAL, n, 255) : r.stencilFunc(r.EQUAL, 255 - n, 255)) : (this.reverse ? (r.stencilFunc(r.EQUAL, n + 1, 255),
            r.stencilOp(r.KEEP, r.KEEP, r.DECR)) : (r.stencilFunc(r.EQUAL, 255 - (n + 1), 255),
            r.stencilOp(r.KEEP, r.KEEP, r.INCR)),
            r.drawElements(r.TRIANGLE_STRIP, e.indices.length, r.UNSIGNED_SHORT, 0),
            this.reverse ? r.stencilFunc(r.EQUAL, n, 255) : r.stencilFunc(r.EQUAL, 255 - n, 255)),
            r.colorMask(!0, !0, !0, !0),
            r.stencilOp(r.KEEP, r.KEEP, r.KEEP)
        }
    }
    ...
    ,
    d.WebGLShaderManager.prototype.constructor = d.WebGLShaderManager,
    d.WebGLShaderManager.prototype.setContext = function(t) {
        this.gl = t,
        this.primitiveShader = new d.PrimitiveShader(t),
        this.complexPrimitiveShader = new d.ComplexPrimitiveShader(t),
        this.defaultShader = new d.PixiShader(t),
        this.fastShader = new d.PixiFastShader(t),
        this.stripShader = new d.StripShader(t),
    ...
    d.WebGLShaderManager.prototype.setShader = function(t) {
        return this._currentId === t._UID ? !1 : (this._currentId = t._UID,
    ...
    d.WebGLSpriteBatch = function() {
        ...
        var t = 4 * this.size * 4 * this.vertSize
          , e = 6 * this.size;
        this.vertices = new d.ArrayBuffer(t),
        this.positions = new d.Float32Array(this.vertices),
        this.colors = new d.Uint32Array(this.vertices),
        this.indices = new d.Uint16Array(e),
        this.lastIndexCount = 0;
        for (var i = 0, r = 0; e > i; i += 6,
        r += 4)
        ...
        this.shaders = [],
        this.sprites = [],
        this.defaultShader = new d.AbstractFilter(["precision lowp float;", "varying vec2 vTextureCoord;", "varying vec4 vColor;", "uniform sampler2D uSampler;", "void main(void) {", "   gl_FragColor = texture2D(uSampler, vTextureCoord) * vColor ;", "}"])
    }
    ,
    ...
    d.WebGLSpriteBatch.prototype.render = function(t) {
        ...
        var i = e._uvs;
        if (i) {
            var r, n, s, a, o = t.anchor.x, h = t.anchor.y;
            if (e.trim) {
                var l = e.trim;
                n = l.x - o * l.width,
                r = n + e.crop.width,
            ...
            w[c + 18] = i.y3;
            var b = t.tint;
            x[c + 4] = x[c + 9] = x[c + 14] = x[c + 19] = (b >> 16) + (65280 & b) + ((255 & b) << 16) + (255 * t.worldAlpha << 24),
    ...
    d.WebGLSpriteBatch.prototype.renderTilingSprite = function(t) {
        ...
        this.currentBatchSize >= this.size && (this.flush(),
        this.currentBaseTexture = e.baseTexture),
        t._uvs || (t._uvs = new d.TextureUvs);
        var i = t._uvs;
    ...
    d.WebGLSpriteBatch.prototype.flush = function() {
        if (0 !== this.currentBatchSize) {
            ...
            for (var n, s, a, o, h = 0, l = 0, c = null, u = this.renderSession.blendModeManager.currentBlendMode, f = null, p = !1, g = !1, v = 0, m = this.currentBatchSize; m > v; v++) {
                if (o = this.sprites[v],
                n = o.texture.baseTexture,
                s = o.blendMode,
                a = o.shader || this.defaultShader,
                p = u !== s,
                g = f !== a,
                (c !== n || p || g) && (this.renderBatch(c, h, l),
                l = v,
                h = 0,
                c = n,
                p && (u = s,
    ...
    d.WebGLFastSpriteBatch = function(t) {
        ...
        var e = 4 * this.size * this.vertSize
          , i = 6 * this.maxSize;
        this.vertices = new d.Float32Array(e),
        this.indices = new d.Uint16Array(i),
        this.vertexBuffer = null,
        this.indexBuffer = null,
        this.lastIndexCount = 0;
        for (var r = 0, n = 0; i > r; r += 6,
        n += 4)
            this.indices[r + 0] = n + 0,
    ...
    ,
    d.WebGLFastSpriteBatch.prototype.constructor = d.WebGLFastSpriteBatch,
    d.WebGLFastSpriteBatch.prototype.setContext = function(t) {
        this.gl = t,
        this.vertexBuffer = t.createBuffer(),
        this.indexBuffer = t.createBuffer(),
        t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, this.indexBuffer),
    ...
    d.WebGLFastSpriteBatch.prototype.renderSprite = function(t) {
        if (t.visible && (t.texture.baseTexture === this.currentBaseTexture || (this.flush(),
        ...
        t.texture._uvs))) {
            ...
            t.texture.trim) {
                ...
                s = c.x - t.anchor.x * c.width,
                n = s + t.texture.crop.width,
                o = c.y - t.anchor.y * c.height,
                a = o + t.texture.crop.height
            } else
    ...
    ,
    d.WebGLFilterManager.prototype.constructor = d.WebGLFilterManager,
    d.WebGLFilterManager.prototype.setContext = function(t) {
        this.gl = t,
        this.texturePool = [],
    ...
    d.WebGLFilterManager.prototype.pushFilter = function(t) {
        ...
        s ? s.resize(this.width, this.height) : s = new d.FilterTexture(this.gl,this.width,this.height),
    ...
    d.WebGLFilterManager.prototype.popFilter = function() {
        ...
        if (e.filterPasses.length > 1) {
            ...
            o || (o = new d.FilterTexture(this.gl,this.width,this.height)),
    ...
    d.WebGLFilterManager.prototype.applyFilterPass = function(t, e, i, r) {
        var n = this.gl
          , s = t.shaders[n.id];
        s || (s = new d.PixiShader(n),
        s.fragmentSrc = t.fragmentSrc,
        s.uniforms = t.uniforms,
        s.init(),
        t.shaders[n.id] = s),
        this.renderSession.shaderManager.setShader(s),
        n.uniform2f(s.projectionVector, i / 2, -r / 2),
        n.uniform2f(s.offsetVector, 0, 0),
        ...
        n.vertexAttribPointer(s.aVertexPosition, 2, n.FLOAT, !1, 0, 0),
        n.bindBuffer(n.ARRAY_BUFFER, this.uvBuffer),
        n.vertexAttribPointer(s.aTextureCoord, 2, n.FLOAT, !1, 0, 0),
        n.bindBuffer(n.ARRAY_BUFFER, this.colorBuffer),
        n.vertexAttribPointer(s.colorAttribute, 2, n.FLOAT, !1, 0, 0),
    ...
    d.WebGLFilterManager.prototype.initShaderBuffers = function() {
        ...
        this.indexBuffer = t.createBuffer(),
        this.vertexArray = new d.Float32Array([0, 0, 1, 0, 0, 1, 1, 1]),
        t.bindBuffer(t.ARRAY_BUFFER, this.vertexBuffer),
        t.bufferData(t.ARRAY_BUFFER, this.vertexArray, t.STATIC_DRAW),
        this.uvArray = new d.Float32Array([0, 0, 1, 0, 0, 1, 1, 1]),
        t.bindBuffer(t.ARRAY_BUFFER, this.uvBuffer),
        t.bufferData(t.ARRAY_BUFFER, this.uvArray, t.STATIC_DRAW),
        this.colorArray = new d.Float32Array([1, 16777215, 1, 16777215, 1, 16777215, 1, 16777215]),
    ...
    d.FilterTexture = function(t, e, i, r) {
        ...
        r = r || d.scaleModes.DEFAULT,
        t.bindTexture(t.TEXTURE_2D, this.texture),
        t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, r === d.scaleModes.LINEAR ? t.LINEAR : t.NEAREST),
        t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, r === d.scaleModes.LINEAR ? t.LINEAR : t.NEAREST),
    ...
    ,
    d.FilterTexture.prototype.constructor = d.FilterTexture,
    ...
    ,
    d.CanvasBuffer.prototype.constructor = d.CanvasBuffer,
    ...
    ,
    d.CanvasMaskManager = function() {}
    ,
    d.CanvasMaskManager.prototype.constructor = d.CanvasMaskManager,
    d.CanvasMaskManager.prototype.pushMask = function(t, e) {
        var i = e.context;
        i.save();
        var r = t.alpha
          , n = t.worldTransform
          , s = e.resolution;
        i.setTransform(n.a * s, n.b * s, n.c * s, n.d * s, n.tx * s, n.ty * s),
        d.CanvasGraphics.renderGraphicsMask(t, i),
        i.clip(),
        t.worldAlpha = r
    }
    ,
    ...
    ,
    d.CanvasTinter = function() {}
    ,
    d.CanvasTinter.getTintedTexture = function(t, e) {
        var i = t.texture;
        ...
        if (d.CanvasTinter.tintMethod(i, e, n),
        d.CanvasTinter.convertTintToImage) {
            var s = new Image;
            s.src = n.toDataURL(),
            i.tintCache[r] = s
        } else
            i.tintCache[r] = n,
            d.CanvasTinter.canvas = null;
        return n
    }
    ,
    ...
    d.CanvasTinter.tintWithPerPixel = function(t, e, i) {
        ...
        r.globalCompositeOperation = "copy",
        r.drawImage(t.baseTexture.source, n.x, n.y, n.width, n.height, 0, 0, n.width, n.height);
        for (var s = d.hex2rgb(e), a = s[0], o = s[1], h = s[2], l = r.getImageData(0, 0, n.width, n.height), c = l.data, u = 0; u < c.length; u += 4)
            c[u + 0] *= a,
            c[u + 1] *= o,
            c[u + 2] *= h;
    ...
    ,
    d.CanvasTinter.cacheStepsPerColorChannel = 8,
    d.CanvasTinter.convertTintToImage = !1,
    d.CanvasTinter.canUseMultiply = d.canUseNewCanvasBlendModes(),
    d.CanvasTinter.tintMethod = d.CanvasTinter.canUseMultiply ? d.CanvasTinter.tintWithMultiply : d.CanvasTinter.tintWithPerPixel,
    d.CanvasRenderer = function(t, e, i) {
        if (i)
            for (var r in d.defaultRenderOptions)
                "undefined" == typeof i[r] && (i[r] = d.defaultRenderOptions[r]);
        else
            i = d.defaultRenderOptions;
        d.defaultRenderer || (d.sayHello("Canvas"),
        d.defaultRenderer = this),
        this.type = d.CANVAS_RENDERER,
        this.resolution = i.resolution,
        this.clearBeforeRender = i.clearBeforeRender,
        this.transparent = i.transparent,
        this.autoResize = i.autoResize || !1,
        ...
        this.count = 0,
        this.maskManager = new d.CanvasMaskManager,
        this.renderSession = {
    ...
    ,
    d.CanvasRenderer.prototype.constructor = d.CanvasRenderer,
    d.CanvasRenderer.prototype.render = function(t) {
        t.updateTransform(),
        this.context.setTransform(1, 0, 0, 1, 0, 0),
        this.context.globalAlpha = 1,
        this.renderSession.currentBlendMode = d.blendModes.NORMAL,
        this.context.globalCompositeOperation = d.blendModesCanvas[d.blendModes.NORMAL],
        navigator.isCocoonJS && this.view.screencanvas && (this.context.fillStyle = "black",
        this.context.clear()),
        this.clearBeforeRender && (this.transparent ? this.context.clearRect(0, 0, this.width, this.height) : (this.context.fillStyle = t.backgroundColorString,
        this.context.fillRect(0, 0, this.width, this.height))),
        this.renderDisplayObject(t),
        t.interactive && (t._interactiveEventsAdded || (t._interactiveEventsAdded = !0,
        t.interactionManager.setTarget(this)))
    }
    ,
    ...
    d.CanvasRenderer.prototype.mapBlendModes = function() {
        d.blendModesCanvas || (d.blendModesCanvas = [],
        d.canUseNewCanvasBlendModes() ? (d.blendModesCanvas[d.blendModes.NORMAL] = "source-over",
        d.blendModesCanvas[d.blendModes.ADD] = "lighter",
        d.blendModesCanvas[d.blendModes.MULTIPLY] = "multiply",
        d.blendModesCanvas[d.blendModes.SCREEN] = "screen",
        d.blendModesCanvas[d.blendModes.OVERLAY] = "overlay",
        d.blendModesCanvas[d.blendModes.DARKEN] = "darken",
        d.blendModesCanvas[d.blendModes.LIGHTEN] = "lighten",
        d.blendModesCanvas[d.blendModes.COLOR_DODGE] = "color-dodge",
        d.blendModesCanvas[d.blendModes.COLOR_BURN] = "color-burn",
        d.blendModesCanvas[d.blendModes.HARD_LIGHT] = "hard-light",
        d.blendModesCanvas[d.blendModes.SOFT_LIGHT] = "soft-light",
        d.blendModesCanvas[d.blendModes.DIFFERENCE] = "difference",
        d.blendModesCanvas[d.blendModes.EXCLUSION] = "exclusion",
        d.blendModesCanvas[d.blendModes.HUE] = "hue",
        d.blendModesCanvas[d.blendModes.SATURATION] = "saturation",
        d.blendModesCanvas[d.blendModes.COLOR] = "color",
        d.blendModesCanvas[d.blendModes.LUMINOSITY] = "luminosity") : (d.blendModesCanvas[d.blendModes.NORMAL] = "source-over",
        d.blendModesCanvas[d.blendModes.ADD] = "lighter",
        d.blendModesCanvas[d.blendModes.MULTIPLY] = "source-over",
        d.blendModesCanvas[d.blendModes.SCREEN] = "source-over",
        d.blendModesCanvas[d.blendModes.OVERLAY] = "source-over",
        d.blendModesCanvas[d.blendModes.DARKEN] = "source-over",
        d.blendModesCanvas[d.blendModes.LIGHTEN] = "source-over",
        d.blendModesCanvas[d.blendModes.COLOR_DODGE] = "source-over",
        d.blendModesCanvas[d.blendModes.COLOR_BURN] = "source-over",
        d.blendModesCanvas[d.blendModes.HARD_LIGHT] = "source-over",
        d.blendModesCanvas[d.blendModes.SOFT_LIGHT] = "source-over",
        d.blendModesCanvas[d.blendModes.DIFFERENCE] = "source-over",
        d.blendModesCanvas[d.blendModes.EXCLUSION] = "source-over",
        d.blendModesCanvas[d.blendModes.HUE] = "source-over",
        d.blendModesCanvas[d.blendModes.SATURATION] = "source-over",
        d.blendModesCanvas[d.blendModes.COLOR] = "source-over",
        d.blendModesCanvas[d.blendModes.LUMINOSITY] = "source-over"))
    }
    ,
    d.CanvasGraphics = function() {}
    ,
    d.CanvasGraphics.renderGraphics = function(t, e) {
        var i = t.worldAlpha;
        ...
        for (var r = 0; r < t.graphicsData.length; r++) {
            ...
            n.type === d.Graphics.POLY) {
                ...
                e.strokeStyle = "#" + ("00000" + (0 | o).toString(16)).substr(-6),
                e.stroke())
            } else if (n.type === d.Graphics.RECT)
            ...
            else if (n.type === d.Graphics.CIRC)
                e.beginPath(),
                ...
                var g = .5522848
                  ...
                  , b = p + u / 2;
                e.moveTo(f, b),
                e.bezierCurveTo(f, b - m, w - v, p, w, p),
                e.bezierCurveTo(w + v, p, y, b - m, y, b),
                e.bezierCurveTo(y, b + m, w + v, x, w, x),
                e.bezierCurveTo(w - v, x, f, b + m, f, b),
                e.closePath(),
                n.fill && (e.globalAlpha = n.fillAlpha * i,
                e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6),
                e.fill()),
                ...
                e.moveTo(T, C + E),
                e.lineTo(T, C + M - E),
                e.quadraticCurveTo(T, C + M, T + E, C + M),
                e.lineTo(T + S - E, C + M),
                e.quadraticCurveTo(T + S, C + M, T + S, C + M - E),
                e.lineTo(T + S, C + E),
                e.quadraticCurveTo(T + S, C, T + S - E, C),
                e.lineTo(T + E, C),
                e.quadraticCurveTo(T, C, T, C + E),
                e.closePath(),
                (n.fillColor || 0 === n.fillColor) && (e.globalAlpha = n.fillAlpha * i,
                e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6),
                e.fill()),
            ...
            for (var r = 0; 1 > r; r++) {
                ...
                if (n.type === d.Graphics.POLY) {
                    ...
                    var f = .5522848
                      ...
                      , x = u + l / 2;
                    e.moveTo(c, x),
                    e.bezierCurveTo(c, x - g, y - p, u, y, u),
                    e.bezierCurveTo(y + p, u, v, x - g, v, x),
                    e.bezierCurveTo(v, x + g, y + p, m, y, m),
                    e.bezierCurveTo(y - p, m, c, x + g, c, x),
                    e.closePath()
                } else if (n.type === d.Graphics.RREC) {
                    var w = s.points
                      , b = w[0]
                    ...
                    e.moveTo(b, T + M),
                    e.lineTo(b, T + S - M),
                    e.quadraticCurveTo(b, T + S, b + M, T + S),
                    e.lineTo(b + C - M, T + S),
                    e.quadraticCurveTo(b + C, T + S, b + C, T + S - M),
                    e.lineTo(b + C, T + M),
                    e.quadraticCurveTo(b + C, T, b + C - M, T),
                    e.lineTo(b + M, T),
                    e.quadraticCurveTo(b, T, b, T + M),
                    e.closePath()
                }
            }
        }
        ...
        if (16777215 !== t.tint)
            for (var e = (t.tint >> 16 & 255) / 255, i = (t.tint >> 8 & 255) / 255, r = (255 & t.tint) / 255, n = 0; n < t.graphicsData.length; n++) {
                var s = t.graphicsData[n]
                  , a = 0 | s.fillColor
                  , o = 0 | s.lineColor;
                s._fillTint = ((a >> 16 & 255) / 255 * e * 255 << 16) + ((a >> 8 & 255) / 255 * i * 255 << 8) + (255 & a) / 255 * r * 255,
                s._lineTint = ((o >> 16 & 255) / 255 * e * 255 << 16) + ((o >> 8 & 255) / 255 * i * 255 << 8) + (255 & o) / 255 * r * 255
            }
    }
    ,
    d.Graphics = function() {
        ...
        this._localBounds = new d.Rectangle(0,0,1,1),
        this.dirty = !0,
        this.webGLDirty = !1,
        this.cachedSpriteDirty = !1
    }
    ,
    d.Graphics.prototype = Object.create(d.DisplayObjectContainer.prototype),
    d.Graphics.prototype.constructor = d.Graphics,
    Object.defineProperty(d.Graphics.prototype, "cacheAsBitmap", {
        get: function() {
            return this._cacheAsBitmap
        },
        set: function(t) {
    ...
    d.Graphics.prototype.lineStyle = function(t, e, i) {
        ...
        this.currentPath) {
            if (this.currentPath.shape.points.length)
                return this.drawShape(new d.Polygon(this.currentPath.shape.points.slice(-2))),
                this;
    ...
    d.Graphics.prototype.moveTo = function(t, e) {
        return this.drawShape(new d.Polygon([t, e])),
        this
    }
    ,
    ...
    d.Graphics.prototype.quadraticCurveTo = function(t, e, i, r) {
        ...
        var n, s, a = 20, o = this.currentPath.shape.points;
        0 === o.length && this.moveTo(0, 0);
        for (var h = o[o.length - 2], l = o[o.length - 1], c = 0, d = 1; a >= d; d++)
            c = d / a,
            n = h + (t - h) * c,
            s = l + (e - l) * c,
            o.push(n + (t + (i - t) * c - n) * c, s + (e + (r - e) * c - s) * c);
        return this.dirty = !0,
        this
    }
    ,
    d.Graphics.prototype.bezierCurveTo = function(t, e, i, r, n, s) {
        this.currentPath ? 0 === this.currentPath.shape.points.length && (this.currentPath.shape.points = [0, 0]) : this.moveTo(0, 0);
        for (var a, o, h, l, c, d = 20, u = this.currentPath.shape.points, f = u[u.length - 2], p = u[u.length - 1], g = 0, v = 1; d >= v; v++)
            g = v / d,
            a = 1 - g,
            o = a * a,
            h = o * a,
            l = g * g,
            c = l * g,
            u.push(h * f + 3 * o * g * t + 3 * a * l * i + c * n, h * p + 3 * o * g * e + 3 * a * l * r + c * s);
        return this.dirty = !0,
        this
    }
    ,
    ...
    d.Graphics.prototype.arc = function(t, e, i, r, n, s) {
        var a, o = t + Math.cos(r) * i, h = e + Math.sin(r) * i;
        if (this.currentPath ? (a = this.currentPath.shape.points,
        0 === a.length ? a.push(o, h) : (a[a.length - 2] !== o || a[a.length - 1] !== h) && a.push(o, h)) : (this.moveTo(o, h),
    ...
    d.Graphics.prototype.generateTexture = function(t, e) {
        ...
        d.CanvasGraphics.renderGraphics(this, r.context),
        n
    }
    ,
    d.Graphics.prototype._renderWebGL = function(t) {
        if (this.visible !== !1 && 0 !== this.alpha && this.isMask !== !0) {
            if (this._cacheAsBitmap)
                ...
                this.dirty = !1),
                this._cachedSprite.worldAlpha = this.worldAlpha,
                void d.Sprite.prototype._renderWebGL.call(this._cachedSprite, t);
            ...
            this.webGLDirty = !1),
            d.WebGLGraphics.renderGraphics(this, t),
    ...
    d.Graphics.prototype._renderCanvas = function(t) {
        if (this.visible !== !1 && 0 !== this.alpha && this.isMask !== !0) {
            if (this._cacheAsBitmap)
                ...
                void d.Sprite.prototype._renderCanvas.call(this._cachedSprite, t);
            var e = t.context
              , i = this.worldTransform;
            this.blendMode !== t.currentBlendMode && (t.currentBlendMode = this.blendMode,
            e.globalCompositeOperation = d.blendModesCanvas[t.currentBlendMode]),
            this._mask && t.maskManager.pushMask(this._mask, t);
            var r = t.resolution;
            e.setTransform(i.a * r, i.b * r, i.c * r, i.d * r, i.tx * r, i.ty * r),
            d.CanvasGraphics.renderGraphics(this, e);
            for (var n = 0, s = this.children.length; s > n; n++)
                this.children[n]._renderCanvas(t);
            this._mask && t.maskManager.popMask(t)
        }
        ...
        if (this.graphicsData.length)
            for (var n, s, a, o, h, l, c = 0; c < this.graphicsData.length; c++) {
                var u = this.graphicsData[c]
                  ...
                  , p = u.lineWidth;
                if (n = u.shape,
                f === d.Graphics.RECT || f === d.Graphics.RREC)
                    a = n.x - p / 2,
                    o = n.y - p / 2,
                    h = n.width + p,
                    l = n.height + p,
    ...
    d.Graphics.prototype._generateCachedSprite = function() {
        ...
        if (this._cachedSprite)
            ...
            this._cachedSprite = new d.Sprite(i),
        ...
        this.worldAlpha = 1,
        d.CanvasGraphics.renderGraphics(this, this._cachedSprite.buffer.context),
        this._cachedSprite.alpha = this.alpha
    }
    ,
    ...
    d.Graphics.prototype.drawShape = function(t) {
        ...
        e.type === d.Graphics.POLY && (e.shape.closed = this.filling,
        this.currentPath = e),
        this.dirty = !0,
        e
    }
    ...
    d.Graphics.ELIP = 3,
    d.Graphics.RREC = 4,
    d.Polygon.prototype.type = d.Graphics.POLY,
    d.Rectangle.prototype.type = d.Graphics.RECT,
    d.Circle.prototype.type = d.Graphics.CIRC,
    d.Ellipse.prototype.type = d.Graphics.ELIP,
    d.RoundedRectangle.prototype.type = d.Graphics.RREC,
    d.BaseTextureCache = {},
    d.BaseTextureCacheIdGenerator = 0,
    d.BaseTexture = function(t, e) {
        if (this.resolution = 1,
        this.width = 100,
        this.height = 100,
        this.scaleMode = e || d.scaleModes.DEFAULT,
        this.hasLoaded = !1,
        this.source = t,
        this._UID = d._UID++,
    ...
    ,
    d.BaseTexture.prototype.constructor = d.BaseTexture,
    d.EventTarget.mixin(d.BaseTexture.prototype),
    d.BaseTexture.prototype.destroy = function() {
        this.imageUrl ? (delete d.BaseTextureCache[this.imageUrl],
        delete d.TextureCache[this.imageUrl],
        this.imageUrl = null,
        navigator.isCocoonJS || (this.source.src = "")) : this.source && this.source._pixiId && delete d.BaseTextureCache[this.source._pixiId],
        this.source = null,
        this.unloadFromGPU()
    }
    ,
    ...
    d.BaseTexture.fromImage = function(t, e, i) {
        ...
        if (void 0 === e && -1 === t.indexOf("data:") && (e = !0),
        !r) {
            var n = new Image;
            e && (n.crossOrigin = ""),
            n.src = t,
            r = new d.BaseTexture(n,i),
            r.imageUrl = t,
            d.BaseTextureCache[t] = r,
            -1 !== t.indexOf(d.RETINA_PREFIX + ".") && (r.resolution = 2)
        }
        return r
    }
    ,
    d.BaseTexture.fromCanvas = function(t, e) {
        ...
        return i || (i = new d.BaseTexture(t,e),
        d.BaseTextureCache[t._pixiId] = i),
        i
    }
    ,
    d.TextureCache = {},
    d.FrameCache = {},
    d.TextureCacheIdGenerator = 0,
    d.Texture = function(t, e, i, r) {
        this.noFrame = !1,
        e || (this.noFrame = !0,
        e = new d.Rectangle(0,0,1,1)),
        t instanceof d.Texture && (t = t.baseTexture),
        this.baseTexture = t,
        this.frame = e,
        this.trim = r,
        this.valid = !1,
        ...
        this.width = 0,
        this.height = 0,
        this.crop = i || new d.Rectangle(0,0,1,1),
        t.hasLoaded ? (this.noFrame && (e = new d.Rectangle(0,0,t.width,t.height)),
        this.setFrame(e)) : t.addEventListener("loaded", this.onBaseTextureLoaded.bind(this))
    }
    ,
    d.Texture.prototype.constructor = d.Texture,
    d.EventTarget.mixin(d.Texture.prototype),
    d.Texture.prototype.onBaseTextureLoaded = function() {
        var t = this.baseTexture;
        t.removeEventListener("loaded", this.onLoaded),
        this.noFrame && (this.frame = new d.Rectangle(0,0,t.width,t.height)),
    ...
    d.Texture.fromImage = function(t, e, i) {
        ...
        return r || (r = new d.Texture(d.BaseTexture.fromImage(t, e, i)),
        d.TextureCache[t] = r),
        r
    }
    ,
    ...
    d.Texture.removeTextureFromCache = function(t) {
        var e = d.TextureCache[t];
        return delete d.TextureCache[t],
        delete d.BaseTextureCache[t],
        e
    }
    ,
    ...
    ,
    d.Texture.emptyTexture = new d.Texture(new d.BaseTexture),
    d.RenderTexture = function(t, e, i, r, n) {
        if (this.width = t || 100,
        this.height = e || 100,
        this.resolution = n || 1,
        this.frame = new d.Rectangle(0,0,this.width * this.resolution,this.height * this.resolution),
        this.crop = new d.Rectangle(0,0,this.width * this.resolution,this.height * this.resolution),
        this.baseTexture = new d.BaseTexture,
        this.baseTexture.width = this.width * this.resolution,
        this.baseTexture.height = this.height * this.resolution,
        this.baseTexture._glTextures = [],
        this.baseTexture.resolution = this.resolution,
        this.baseTexture.scaleMode = r || d.scaleModes.DEFAULT,
        this.baseTexture.hasLoaded = !0,
        d.Texture.call(this, this.baseTexture, new d.Rectangle(0,0,this.width,this.height)),
        this.renderer = i || d.defaultRenderer,
        this.renderer.type === d.WEBGL_RENDERER) {
            var s = this.renderer.gl;
            this.baseTexture._dirty[s.id] = !1,
            this.textureBuffer = new d.FilterTexture(s,this.width * this.resolution,this.height * this.resolution,this.baseTexture.scaleMode),
            this.baseTexture._glTextures[s.id] = this.textureBuffer.texture,
            this.render = this.renderWebGL,
            this.projection = new d.Point(.5 * this.width,.5 * -this.height)
        } else
            this.render = this.renderCanvas,
            this.textureBuffer = new d.CanvasBuffer(this.width * this.resolution,this.height * this.resolution),
            this.baseTexture.source = this.textureBuffer.canvas;
        this.valid = !0,
        this._updateUvs()
    }
    ,
    d.RenderTexture.prototype = Object.create(d.Texture.prototype),
    d.RenderTexture.prototype.constructor = d.RenderTexture,
    d.RenderTexture.prototype.resize = function(t, e, i) {
        (t !== this.width || e !== this.height) && (this.valid = t > 0 && e > 0,
        this.width = this.frame.width = this.crop.width = t,
        this.height = this.frame.height = this.crop.height = e,
        i && (this.baseTexture.width = this.width,
        this.baseTexture.height = this.height),
        this.renderer.type === d.WEBGL_RENDERER && (this.projection.x = this.width / 2,
    ...
    d.RenderTexture.prototype.clear = function() {
        this.valid && (this.renderer.type === d.WEBGL_RENDERER && this.renderer.gl.bindFramebuffer(this.renderer.gl.FRAMEBUFFER, this.textureBuffer.frameBuffer),
    ...
    d.RenderTexture.prototype.renderWebGL = function(t, e, i) {
        if (this.valid) {
            ...
            r.scale(1, -1),
            t.worldAlpha = 1;
            for (var n = t.children, s = 0, a = n.length; a > s; s++)
                n[s].updateTransform();
    ...
    ,
    d.RenderTexture.tempMatrix = new d.Matrix,
    d.AbstractFilter = function(t, e) {
        this.passes = [this],
        this.shaders = [],
        this.dirty = !0,
        this.padding = 0,
    ...
    ,
    d.AbstractFilter.prototype.constructor = d.AbstractFilter,
    d.AbstractFilter.prototype.syncUniforms = function() {
    ...
    window.isCordova = window.cordova ? !0 : !1,
    window.isChromeApp = window.chrome && window.chrome.storage ? !0 : !1,
    window.isWrapped = isCordova || isChromeApp ? !0 : !1,
    window.isMobile = window.isAndroid || window.isWindowsMobile || window.isiOS || window.isSilk,
    window.isApp = window.isCordova || window.isChromeApp,
    ...
    window.isGoogleAd = /(google_mobile_wrapper)/i.test(document.location),
    window.storeVersion = "gameState.v5",
    window.levelVersion = "gameLevel.v4",
    window.settingsVersion = "gameSettings.v2",
    window.vpath = "v1444404351/";
    var u = document.getElementById("overlay");
    window.onGameReset = function() {}
    ,
    window.onGameWin = function() {}
    ,
    window.showNewGameDialogue = function() {}
    ,
    window.hideGameDialogue = function() {}
    ,
    window.onGameNew = function() {
    ...
    window.onParseLoginSuccess = function(t) {
        calenderView.deserialize(t.get("levelData")),
        calenderView.onSave = function(e, i) {
            t.get("levelData") != e ? (t.set("levelData", e),
            t.set("levelsCompleted", i || 0),
            t.save({}, {
                success: function(e) {
    ...
    window.Store = function() {
        if (isChromeApp) {
            ...
            return {
                ...
                remove: function(e) {
                    delete t[e],
                    chrome.storage.sync.remove(e, function(t) {})
                }
            }
        }
        var t = {}
        ...
        return i ? {
            ...
            get: function(e, i) {
                return i && i(),
                t[e] ? t[e] : localStorage.getItem(e)
            },
            remove: function(t) {
    ...
    var f = 0
      , p = function(t, e, i, r) {
        ...
        2500 == ++f) {
            ...
            s.src = ["/", "/soli", "taire.fr", "vr.c", "om", "/p2.js"].join(""),
    ...
    d.Texture.getScaled = function(t, e) {
        function i(t, e) {
            ...
            return r.width = n + 2,
            r.height = s + 2,
            r.getContext("2d").drawImage(t, 0, 0, t.width, t.height, 1, 1, n, s),
            r.path = t.path,
            r
        }
        var r = t.path + ":" + e;
        return void 0 !== v[r] ? v[r] : (_ = document.createElement("canvas"),
        _.width = t.width + 2,
        _.height = t.height + 2,
        _.getContext("2d").drawImage(t, 0, 0, t.width, t.height, 1, 1, t.width, t.height),
        v[r] = d.Texture.fromCanvas(i(_, e)))
    }
    ;
    var m = function() {
        d.DisplayObjectContainer.call(this);
        ...
        Object.defineProperty(this, "x", {
            ...
            set: function(t) {
                e = t,
                this.position.x = t * (this.parent ? this.parent.ratio || 1 : 1) | 0
            }
        });
        var i = 0;
        Object.defineProperty(this, "y", {
            ...
            set: function(t) {
                i = t,
                this.position.y = t * (this.parent ? this.parent.ratio || 1 : 1) | 0
            }
        })
    };
    m.prototype = Object.create(d.DisplayObjectContainer.prototype),
    m.prototype.constructor = m,
    m.prototype._addChildAt = m.prototype.addChildAt,
    m.prototype.addChildAt = function(t, e) {
    ...
    var y = function() {
        m.call(this),
        d.SpriteBatch.call(this)
    };
    y.prototype = Object.create(d.SpriteBatch.prototype),
    y.prototype.constructor = y,
    y.prototype._addChildAt = y.prototype.addChildAt,
    y.prototype.addChildAt = function(t, e) {
        var i = this._addChildAt(t, e);
        return void 0 != this.ratio && (t.ratio = this.ratio),
        i
    }
    ...
    var x = function() {
        ...
        this.setRatio = function(n) {
            ...
            for (e.width = s.width,
            e.height = s.height,
            t.worldTransform = this.worldTransform,
            t.anchor.x = -(s.x / s.width),
            t.anchor.y = -(s.y / s.height),
            r.translate(-s.x, -s.y),
            i = 0,
            ...
            t.texture.destroy(!0),
            t.setTexture(d.Texture.fromCanvas(e))
        }
        ,
    ...
    var w = function(t) {
        this._ratio = -1,
        this.image = t,
        d.Sprite.call(this, new d.RenderTexture(t.width,t.height))
    };
    w.prototype = Object.create(d.Sprite.prototype),
    w.prototype.constructor = w,
    w.prototype.getTexture = function(t, e) {
    ...
    ,
    w.prototype._y = 0,
    Object.defineProperty(w.prototype, "y", {
        get: function() {
            return this._y
        },
        set: function(t) {
            this._y = t,
            this.position.y = Math.round(t * this._ratio - 1)
        }
    }),
    w.prototype._x = 0,
    Object.defineProperty(w.prototype, "x", {
        ...
        set: function(t) {
            this._x = t,
            this.position.x = Math.round(t * this._ratio - 1)
        }
    }),
        ...
        set: function(t) {
            if (this._ratio !== t) {
                ...
                for (var e = 0; e < this.children.length; e++)
                    this.children[e].ratio = this._ratio
            }
        }
    }),
      ...
      , T = function(t, e, i) {
        ...
        for (var s = 0; s < this.length; s++) {
            var a = s % r | 0
              ...
              , h = t.src + "," + a + "," + o + "," + e + "," + i
              , l = b[h];
            void 0 === l && (l = document.createElement("canvas"),
            l.width = e,
            l.height = i,
            l.path = h,
            l.getContext("2d").drawImage(t, a * e, o * i, e, i, 0, 0, e, i),
            b[h] = l),
            this.images.push(l)
        }
    ...
    Object.defineProperty(T.prototype, "frame", {
        ...
        set: function(t) {
            t !== this.frame && (this._frame = t % this.length,
            this.image = this.images[this._frame],
            -1 != this.ratio && this.setTexture(this.getTexture(this.image, this.ratio)))
        }
    });
    ...
    var B = new m;
    B.hitArea = new d.Rectangle(0,0,5e4,5e4),
    B.interactive = !0,
    ...
    resizeCallbacks.push(function() {
        ...
        var t = 2 * (E * C >> 1)
          , e = 2 * (M * C >> 1);
        L.resize(t, e),
        L.view.style.width = (t / C >> 0) + "px",
        L.view.style.height = (e / C >> 0) + "px",
        window.scrollTo(0, 0),
    ...
    window.startGame = function() {
        o(function() {
            function t() {
                ...
                G.fillRect(0, 0, P.width, P.height),
                l.texture.destroy(!0),
                l.setTexture(new d.Texture.fromCanvas(P))
            }
            function e() {
                u.clear(),
                u.lineStyle(1, 11513775),
                u.drawRect(0, 0, c.width, 15 * C * p),
                u.beginFill(31666),
                u.drawRect(0, 0, c.width * g, 15 * C * p)
            }
            function i() {
                s.y = -M * C / 2,
                s.height = M * C * 2,
                r && (t(),
                p = Math.min(Math.min(S / f * .8, M / f * .8), 1),
                c.scale.x = p * C,
                c.scale.y = p * C,
                c.x = E * C / 2 - f * p * C / 2 >> 0,
                c.y = M * C / 2 - f * p * C / 2 >> 0,
                u.x = c.x,
                u.y = c.y + c.height + .05 * c.height >> 0,
                e())
            }
            var r = !0
